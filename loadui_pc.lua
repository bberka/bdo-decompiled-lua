...
function preLoadGameUI_PC()
  ...
  if true == ToClient_IsDevelopment() then
    basicLoadUI("UI_Data/Window/Log/Panel_Window_DamageLog.XML", "Panel_Window_DamageLog", Defines.UIGroup.PAGameUIGroup_Windows)
    basicLoadUI("UI_Data/Window/Log/Panel_Window_DamageLog_Detail.XML", "Panel_Window_DamageLog_Detail", Defines.UIGroup.PAGameUIGroup_Windows)
  end
  ...
  loadUI("UI_Data/Window/Tutorial/Panel_ContentsTutorial.XML", "Panel_ContentsTutorial_All", UIGroup.PAGameUIGroup_ModalDialog, PAUIRenderModeBitSet({
    RenderMode.eRenderMode_Default,
    RenderMode.eRenderMode_Dialog
  }))
...
function loadGameUI_PC()
  ...
  runLua("UI_Data/Script/QASupport/QASupportDamage_Corsair.lua")
  runLua("UI_Data/Script/QASupport/QASupportDamage_Drakania.lua")
