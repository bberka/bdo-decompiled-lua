...
function seasonList:getTextureControl(panel)
  UI.ASSERT_NAME(nil ~= panel, "seasonList:getTextureControl panel nil", "ì²œë§Œê¸°")
...
function seasonList:getObjectControl(panel, control)
  UI.ASSERT_NAME(nil ~= panel, "seasonList:getObjectControl panel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= control, "seasonList:getObjectControl control nil", "ì²œë§Œê¸°")
  local panelId = panel:GetID()
  local objectControl = {}
  if __eSeasonUIType_Summer == currentSeasonUIType then
...
function PaGlobal_SeasonTexture_ShowChangePanelTexture(currentPanelName)
  ...
  UI.ASSERT_NAME(nil ~= currentPanelName, "PaGlobal_SeasonTexture_ShowChangePanelTexture currentPanelName nil", "ì²œë§Œê¸°")
  ...
  UI.ASSERT_NAME(nil ~= index, "PaGlobal_SeasonTexture_ShowChangePanelTexture index nil", "ì²œë§Œê¸°")
  control:ChangeTextureInfoName(ddsLink)
