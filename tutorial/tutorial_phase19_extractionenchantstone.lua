...
function PaGlobal_TutorialPhase_ExtractionEnchantStone:startPhaseXXX(stepNo)
  ...
  _PA_LOG("ê³½ë¯¼ìš°", "PaGlobal_TutorialPhase_ExtractionEnchantStone:startStep() stepNo : " .. tostring(stepNo) .. " typeNo : " .. tostring(typeNo))
  self._currentStep = 0
...
function PaGlobal_TutorialPhase_ExtractionEnchantStone:eventCallStep1ClickedDialogFuncButton(funcButtonType)
  _PA_LOG("ê³½ë¯¼ìš°", "funcButtonType : " .. tostring(funcButtonType))
