function PaGlobal_CharacterSelect_All:initialize()
  ...
  self._ui.btn_CreateCharacter = UI.getChildControl(self._ui.stc_RightBg, "Button_CreateCharacter")
  self._ui.txt_SubDesc = UI.getChildControl(self._ui.btn_CreateCharacter, "StaticText_SubDesc")
  self._ui.stc_AbleIcon = UI.getChildControl(self._ui.btn_CreateCharacter, "Static_AbleIcon")
  self._ui.stc_DisableIcon = UI.getChildControl(self._ui.btn_CreateCharacter, "Static_DisableIcon")
  ...
  self._ui.btn_CreateCharacter:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_CharacterSelect_All:swichPlatform(isUsePadSnapping)
  ...
  self._ui.btn_CreateCharacter:SetShow(not isUsePadSnapping)
...
function PaGlobal_CharacterSelect_All:update()
  ...
  self._playerData.maxSlot = getCharacterSlotMaxCount(self._isPrimiumCharacter)
  ...
  if self._playerData.haveCount < self._playerData.maxSlot then
    self._ui.stc_AbleIcon:SetShow(true)
    self._ui.stc_DisableIcon:SetShow(false)
  else
    self._ui.stc_AbleIcon:SetShow(false)
    self._ui.stc_DisableIcon:SetShow(true)
  end
end
...
function PaGlobal_CharacterSelect_All:setCharacterView(charIdx, classType, isPrimiumCharacter, isChangeSpecialTab)
  ...
  elseif classType == __eClassType_Corsair then
    ...
    setWeatherTime(6, 3)
  elseif classType == __eClassType_Drakania then
    viewCharacter(charIdx, -35, -20, -80, -0,1, isPrimiumCharacter, isChangeSpecialTab)
    viewCharacterPitchRoll(0, 0)
    viewCharacterFov(0,75)
    setWeatherTime(0, 4)
  elseif classType == __eClassType_Giant_Reserved0 then
...
function PaGlobal_CharacterSelect_All:validate()
  ...
  self._ui.stc_AbleIcon:isValidate()
  self._ui.stc_DisableIcon:isValidate()
