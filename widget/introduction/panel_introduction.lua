...
function FGlobal_Introduction_TooltipShow(uiControl, name, desc, isClose, actorKey)
  ...
  if __eClassType_Lhan == playerClass or __eClassType_RangerMan == playerClass or __eClassType_ShyWaman == playerClass or __eClassType_Guardian == playerClass or __eClassType_Hashashin == playerClass or __eClassType_Nova == playerClass or __eClassType_Sage == playerClass or __eClassType_Corsair == playerClass or __eClassType_Drakania == playerClass then
