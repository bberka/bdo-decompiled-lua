...
function PaGlobal_Widget_HadumField_Enter_All_IsShowEnterButton()
  ...
  if curChannelData._isSiegeChannel == true or curChannelData._isInstanceChannel == true then
    return false
  end
...
function PaGlobal_Widget_HadumField_All_CheckChangeState(isOnlyCheck)
  ...
  if PaGlobal_Widget_HadumField_Enter_All_IsShowEnterButton() == false then
    return false
  end
  ...
  if housing_getHouseholdActor_CurrentPosition() ~= nil then
