...
function PaGlobal_Widget_FunctionButton_Console:checkButton(functionType)
  ...
  if nil == selfPlayerWrapper then
    UI.ASSERT_NAME(false, "ë¹„ì •ìƒì…ë‹ˆë‹¤. selfPlayerWrapperê°€ nullptrì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
...
function PaGlobal_Widget_FunctionButton_Console:prepareOpen()
  ...
  if true == self._buttonShow[Widget_Function_Type_Console.GrowthPass] or true == self._buttonShow[Widget_Function_Type_Console.YachtPvP] then
