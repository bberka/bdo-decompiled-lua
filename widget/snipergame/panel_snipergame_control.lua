...
function PaGlobal_SniperGame_PanelManager:setPanel(ePanelType, panel)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_SniperGame_PanelManager:setPanel ePanelType nil", "ì •ì§€í˜œ")
  UI.ASSERT_NAME(nil ~= panel, "PaGlobal_SniperGame_PanelManager:setPanel panel nil", "ì •ì§€í˜œ")
...
function PaGlobal_SniperGame_PanelManager:getPanel(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_SniperGame_PanelManager:getPanel ePanelType nil", "ì •ì§€í˜œ")
  if PaGlobal_SniperGame_PanelManager._eType._sniper == ePanelType then
...
function PaGlobal_SniperGame_PanelManager:checkLoadUI(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobalFunc_SniperGame_CheckLoadUI ePanelType nil", "ì •ì§€í˜œ")
  local rv
  if PaGlobal_SniperGame_PanelManager._eType._sniper == ePanelType then
...
function PaGlobal_SniperGame_PanelManager:Initialize(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_SniperGame_PanelManager:initialize ePanelType nil", "ì •ì§€í˜œ")
  if PaGlobal_SniperGame_PanelManager._eType._sniper == ePanelType then
...
function PaGlobal_SniperGame_PanelManager:checkCloseUI(ePanelType, isAni)
  ...
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_SkillWindowManager:checkCloseUI ePanelType nil", "ì •ì§€í˜œ")
...
function PaGlobal_SniperGame_PanelManager_SetShowPanelStatus(isShow, isAni)
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_SniperGame_PanelManager_SetShowPanelStatus isShow nil", "ì •ì§€í˜œ")
