...
function PAGlobal_UpdateHadum(isShow)
  if nil == Panel_Widget_AreaOfHadum then
    return
  end
  PaGlobal_AreaOfHadum:OpenAndCloseButtonChangeToCloseIcon()
  PaGlobal_AreaOfHadum._ui._isOpen = true
  PaGlobal_AreaOfHadum:open(isShow)
end
