function PaGlobal_Window_Stat_All:initialize()
  ...
  if true == isGameTypeKR2() then
    self._ui._txt_addedDDToKama_title:SetShow(false)
    self._ui._txt_addedDDToHuman_title:SetPosY(self._ui._txt_addedDDToAin_title:GetPosY())
    self._ui._txt_addedDDToAin_title:SetPosY(self._ui._txt_addedDDToKama_title:GetPosY())
    self._ui._txt_addedDDToKama:SetShow(false)
    self._ui._txt_addedDDToHuman:SetPosY(self._ui._txt_addedDDToAin:GetPosY())
    self._ui._txt_addedDDToAin:SetPosY(self._ui._txt_addedDDToKama:GetPosY())
  end
...
function PaGlobal_Window_Stat_All:update(isCheck)
  ...
  if _ContentsGroup_MajorSiegeLimitStat == true and PaGlobal_Window_Stat_All._majorLimitPanel ~= nil and PaGlobal_Window_Stat_All._majorLimitPanel:GetShow() == true then
    isUpdate = true
  end
