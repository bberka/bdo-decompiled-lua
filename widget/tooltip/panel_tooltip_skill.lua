...
function Tooltip_SkillData:showTooltip_Skill_Real(target, skillNo, skillTypeSS, isShowNextLevel, isReserveSkillOn, isResetable)
  ...
  elseif __eClassType_Warrior == playerWrapper:getClassType() or __eClassType_Giant == playerWrapper:getClassType() or __eClassType_BladeMaster == playerWrapper:getClassType() or __eClassType_BladeMasterWoman == playerWrapper:getClassType() or __eClassType_Kunoichi == playerWrapper:getClassType() or __eClassType_NinjaMan == playerWrapper:getClassType() or __eClassType_Combattant == playerWrapper:getClassType() or __eClassType_Mystic == playerWrapper:getClassType() or __eClassType_Lhan == playerWrapper:getClassType() or __eClassType_Guardian == playerWrapper:getClassType() or __eClassType_Drakania == playerWrapper:getClassType() or __eClassType_Giant_Reserved0 == playerWrapper:getClassType() or __eClassType_Giant_Reserved2 == playerWrapper:getClassType() or __eClassType_KunoichiOld == playerWrapper:getClassType() then
