...
function PaGlobal_ClassResource_All:resizeInitData()
  ...
  elseif self._curClassType == __eClassType_Giant_Reserved2 then
    self._ui._stc_kunoBG:SetShow(PaGlobal_ClassResource_CanSuccessionIconEnable(__eClassType_Giant_Reserved2))
...
function Phantom_Locate()
  ...
  elseif Panel_ClassResource:GetRelativePosX() == 0 and Panel_ClassResource:GetRelativePosY() == 0 then
    Panel_ClassResource:SetPosX(getScreenSizeX() / 2 - Panel_MainStatus_User_Bar:GetSizeX() / 2 + self._ui._stc_sorcererBG:GetSizeX() - 5)
    Panel_ClassResource:SetPosY(getScreenSizeY() - Panel_QuickSlot:GetSizeY() - Panel_MainStatus_User_Bar:GetSizeY() - self._ui._stc_sorcererBG:GetSizeY() + 5 - spanPosY)
  else
...
function PaGlobal_ClassResource_CanUseResourceIcon(classType)
  ...
  if classType == __eClassType_Sorcerer or classType == __eClassType_Combattant or classType == __eClassType_Mystic or classType == __eClassType_ShyWaman then
    return true
  end
