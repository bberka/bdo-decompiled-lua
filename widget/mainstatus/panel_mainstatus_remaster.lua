...
function MainStatus:setMPBarTexture()
  ...
  elseif classType == __eClassType_Sorcerer or classType == __eClassType_WizardWoman or classType == __eClassType_WizardMan or classType == __eClassType_Tamer or classType == __eClassType_Hashashin or classType == __eClassType_Sage or classType == __eClassType_Corsair then
...
function MainStatus:updateEXP()
  ...
  if not self._levelUpQuestClear then
    if true == isGameTypeKR2() then
      if 49 == player:getLevel() then
    ...
    elseif 49 <= player:getLevel() and player:getLevel() < 60 then
      if self._oldCharacter then
        Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_MAXLEVELUP_YESLIMIT_NOBOSS"))
      else
        Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_MAXLEVELUP_NOLIMIT_YESBOSS"))
