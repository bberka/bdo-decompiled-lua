...
PaGlobal_Menu._bannerData = {
  _hot = {
    ...
    [PaGlobal_Menu._bannerHot._update] = {
      ...
      _x2 = 376,
      _y2 = 464,
      _isContentOpen = isGameTypeTH() or isGameTypeID() or isGameTypeTR() or isGameTypeTaiwan() or isGameTypeKorea() or not PaGlobal_Menu._contentsGroup._isTestServer
    },
...
PaGlobal_Menu._categoryData = {
  ...
  [3] = {
    ...
    [PaGlobal_Menu._infomation._update] = {
      ...
      _x2 = 186,
      _y2 = 372,
      _isContentOpen = isGameTypeID() or isGameTypeTH() or isGameTypeTR() or isGameTypeTaiwan() or isGameTypeKorea() or not PaGlobal_Menu._contentsGroup._isTestServer,
      _isNew = false,
      _isHot = true,
      _index = 39
    },
    ...
    [PaGlobal_Menu._infomation._knownIssue] = {
      ...
      _x2 = 558,
      _y2 = 372,
      _isContentOpen = isGameTypeTH() or isGameTypeTaiwan() or isGameTypeKorea() or not PaGlobal_Menu._contentsGroup._isTestServer,
      _isNew = false,
      _isHot = false,
      _index = 62
    },
...
function PaGlobal_Menu:HandleClicked_MenuButton(index, categoryIndex, uiIndex)
  ...
  elseif 4 == categoryIndex then
    ...
    elseif PaGlobal_Menu._community._feedBack == index then
      local isUrl = ToClient_getGTAccountURL() .. "/Member/Login"
...
function ChangeUI_Menu_New()
  ...
  Panel_Menu_ShowToggle()
  ToClient_getGameUIManagerWrapper():sendToMenuTypeChange()
end
