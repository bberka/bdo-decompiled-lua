...
PaGlobal_Menu_Renew._categoryData = {
  ...
  [PaGlobal_Menu_Renew._xbox._arshaPvP] = {
    ...
    txt_hotKey = "",
    _isVisible = ToClient_IsGrowStepOpen(__eGrowStep_arsha) and _ContentsGroup_Arsha,
    _path = "Combine/Console/Combine_Console_ESCMenuIcon.dds",
    _x1 = 116,
    _y1 = 287,
    _x2 = 171,
...
function PaGlobal_Menu_Renew:HandleClicked_MenuButton(index)
  ...
  elseif self._xbox._escape == index then
    ...
    elseif true == ToClient_getJoinGuildBattle() then
      ...
      return
    elseif true == _ContentsGroup_PersonalField then
      if true == ToClient_IsEnterMirrorField() then
        ...
        return
      elseif false == ToClient_CheckPersonalFieldDelayTime(true) then
        return
      end
    end
