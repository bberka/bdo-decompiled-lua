  ...
  _menuHotKeyTemp = {
    ...
    [2] = {
      subMenu = {
        ...
        [2] = {
          ...
          isContentOpen = not PaGlobal_Menu_Remake._contentsGroup._isTestServer and not isGameTypeKR2() and not _ContentsGroup_RenewUI,
          index = 1
        },
        [3] = {
    ...
    [3] = {
      subMenu = {
        ...
        [8] = {
          ...
          isContentOpen = not _ContentsGroup_RenewUI and false == isGameTypeKR2(),
          index = 67
        },
        [9] = {
        ...
        [10] = {
          ...
          isContentOpen = _ContentsGroup_CharacterTag and _ContentsGroup_UsePadSnapping,
          index = 90
        },
        [11] = {
    ...
    [6] = {
      subMenu = {
        ...
        [10] = {
          func = HandleEventLUp_HopeGaugeOnOff_Open,
    ...
    [8] = {
      subMenu = {
        ...
        [4] = {
          ...
          isContentOpen = ToClient_IsGrowStepOpen(__eGrowStep_savageDefence) and PaGlobal_Menu_Remake._contentsGroup._isSavageOpen and false,
          index = 42
        },
        [5] = {
        ...
        [11] = {
          func = HandleEventLUp_MenuRemake_SheriffRank,
          isContentOpen = _ContentsGroup_sheriff,
          index = 111
        },
        [12] = {
          func = HandleEventLUp_MenuRemake_ReportBadMan,
          isContentOpen = _ContentsGroup_sheriff,
          index = 112
        },
        [13] = {
    ...
    [9] = {
      subMenu = {
        ...
        [3] = {
          ...
          isContentOpen = false == isGameTypeKR2(),
          index = 10
        },
        [4] = {
        ...
        [5] = {
          ...
          isContentOpen = true == _ContentsGroup_Maid and false == isGameTypeKR2(),
          index = 17
        },
        [6] = {
    ...
    [10] = {
      subMenu = {
        ...
        [7] = {
          ...
          isContentOpen = not PaGlobal_Menu_Remake._contentsGroup._isTestServer and false == isGameTypeKR2() and false == _ContentsGroup_RenewUI,
          index = 56
        },
        [8] = {
        ...
        [10] = {
          ...
          isContentOpen = false == isGameTypeJapan() and not _ContentsGroup_RenewUI and not isGameTypeKR2(),
          index = 72
        },
        [11] = {
        ...
        [17] = {
          ...
          isContentOpen = _ContentsGroup_QuizEvent and _ContentsGroup_RenewUI and PaGlobal_Menu_Remake._conditionGroup._isGMQuizCall,
          index = 115
        },
        [18] = {
    ...
    [12] = {
      subMenu = {
        ...
        [2] = {
          ...
          isContentOpen = isGameTypeRussia() or isGameServiceTypeDev() or isGameTypeTH() or isGameTypeID() or isGameTypeTR() or isGameTypeTaiwan() or isGameTypeKorea() or not PaGlobal_Menu_Remake._contentsGroup._isTestServer,
          index = 69
        },
        [3] = {
          func = HandleEventLUp_MenuRemake_Event,
          isContentOpen = not isGameTypeKR2() and not isGameTypeEnglish() and not PaGlobal_Menu_Remake._contentsGroup._isTestServer and not _ContentsGroup_RenewUI,
          index = 70
        },
        [4] = {
          func = HandleEventLUp_MenuRemake_KnownIssue,
          isContentOpen = isGameTypeTR() or isGameTypeRussia() or isGameTypeID() or isGameTypeTH() or isGameTypeTaiwan() or isGameTypeKorea() or not PaGlobal_Menu_Remake._contentsGroup._isTestServer,
          index = 71
        },
        [5] = {
          func = HandleEventLUp_MenuRemake_BlackDesertLab,
          isContentOpen = PaGlobal_Menu_Remake._contentsGroup._isBlackDesertLab and not _ContentsGroup_RenewUI and not isGameTypeEnglish(),
          index = 96
        },
        [6] = {
        ...
        [8] = {
          ...
          isContentOpen = CppEnums.CountryType.JPN_REAL ~= getGameServiceType() and CppEnums.CountryType.JPN_ALPHA ~= getGameServiceType() and false == isGameTypeKR2() and not _ContentsGroup_RenewUI,
          index = 33
        },
        [9] = {
          func = PaGlobalFunc_CouponCode_Open,
          isContentOpen = _ContentsGroup_CouponCode and not isGameTypeKR2(),
          index = 93
        }
      }
    }
    ...
    if nil ~= MenuSS then
      ...
      for jj = 1, MenuSS._subMenuSize do
        ...
        if nil ~= SubMenuSS then
          _menuHotKeyTemp[ii].subMenu[jj].title = PAGetString(SubMenuSS:getTitleSheetName(), SubMenuSS:getTitleName())
