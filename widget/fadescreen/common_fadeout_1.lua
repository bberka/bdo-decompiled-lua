...
function PaGlobal_FadeOut:initBackGroundImageForException()
  ...
  if true == _ContentsGroup_RebootStoryBalenos then
    PaGlobal_FadeOut._bgImageTexture = {
  ...
  elseif true == _ContentsOption_CH_LoadingImage then
    PaGlobal_FadeOut._bgImageTexture = {
      [0] = "New_UI_Common_forLua/Window/Lobby/bgCalpeon_2.dds ",
      [1] = "New_UI_Common_forLua/Window/Lobby/bgCalpeon_3.dds ",
      [2] = "New_UI_Common_forLua/Window/Lobby/bgCalpeon_4.dds ",
      [3] = "New_UI_Common_forLua/Window/Lobby/bgCalpeon_6.dds "
    }
    self._totalImageCount = 4
  else
    PaGlobal_FadeOut._bgImageTexture = {
