...
function PaGlobal_ChatSubMenu:SetShow(isShow, isInviteParty, isInviteGuild, isInviteCompetition, isGameManager, isRecommand, clickedName, clickedUserNickName, isPearlAppUser)
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatSubMenu:SetShow isShow nil", "ì²œë§Œê¸°")
  if false == isShow then
    Panel_Chat_SubMenu:SetShow(false)
    return
  end
  UI.ASSERT_NAME(nil ~= isInviteParty, "PaGlobal_ChatSubMenu:SetShow isInviteParty nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isInviteGuild, "PaGlobal_ChatSubMenu:SetShow isInviteGuild nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isInviteCompetition, "PaGlobal_ChatSubMenu:SetShow isInviteCompetition nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isGameManager, "PaGlobal_ChatSubMenu:SetShow isGameManager nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= clickedName, "PaGlobal_ChatSubMenu:SetShow clickedName nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= clickedUserNickName, "PaGlobal_ChatSubMenu:SetShow clickedUserNickName nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isPearlAppUser, "PaGlobal_ChatSubMenu:SetShow isPearlAppUser nil", "ì‹ ìŠ¹ê¶Œ")
  local bgSizeY = 165
  ...
  if true == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_Solare) then
    PaGlobal_ChatSubMenu._ui._staticBg:SetText("\n" .. clickedUserNickName)
  else
...
function PaGlobal_ChatSubMenuSetClickedInfo(currentPoolIndex, clickedMessageIndex, clickedName, clickedUserNickName, clickedMsg, senderUserNo, chatRoomNo)
  UI.ASSERT_NAME(nil ~= currentPoolIndex, "PaGlobal_ChatSubMenuSetClickedInfo currentPoolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= clickedMessageIndex, "PaGlobal_ChatSubMenuSetClickedInfo clickedMessageIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= clickedName, "PaGlobal_ChatSubMenuSetClickedInfo clickedName nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= clickedUserNickName, "PaGlobal_ChatSubMenuSetClickedInfo clickedUserNickName nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= clickedMsg, "PaGlobal_ChatSubMenuSetClickedInfo clickedMsg nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= senderUserNo, "PaGlobal_ChatSubMenuSetClickedInfo senderUserNo nil", "ê¹€ì§€í˜")
  UI.ASSERT_NAME(nil ~= chatRoomNo, "PaGlobal_ChatSubMenuSetClickedInfo chatRoomNo nil", "ê¹€ì§€í˜")
