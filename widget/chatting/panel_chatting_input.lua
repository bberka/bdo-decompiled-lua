...
function ChatInput_IsInstantCommand_Whisper(str)
  return str == "/w" or str == "/ã…ˆ" or str == "/whisper" or str == "/ê·“ì†ë§" or str == "/ê·“"
end
function ChatInput_IsInstantCommand_Reply(str)
  return str == "/r" or str == "/ã„±" or str == "/reply" or str == "/ëŒ€ë‹µ" or str == "/ëŒ€"
end
function ChatInput_IsInstantCommand_Normal(str)
  return str == "/s" or str == "/ã„´" or str == "/ì¼ë°˜" or str == "/ì¼"
end
function ChatInput_IsInstantCommand_World(str)
  return str == "/y" or str == "/ã…›" or str == "/yell" or str == "/ì™¸ì¹¨" or str == "/ì™¸"
end
function ChatInput_IsInstantCommand_Party(str)
  return str == "/p" or str == "/ã…”" or str == "/party" or str == "/íŒŒí‹°" or str == "/íŒŒ"
end
function ChatInput_IsInstantCommand_Guild(str)
  return str == "/g" or str == "/ã…" or str == "/guild" or str == "/ê¸¸ë“œ" or str == "/ê¸¸"
end
function ChatInput_IsInstantCommand_WithItem(str)
  return str == "/a" or str == "/ã…" or str == "/all" or str == "/ì „ì²´" or str == "/ì „"
end
function ChatInput_IsInstantCommand_Arsha(str)
  return str == "/c" or str == "/ã…Š" or str == "/arsha" or str == "/ì•„ë¥´ìƒ¤"
end
function ChatInput_IsInstantCommand_Team(str)
  return str == "/t" or str == "/ã……" or str == "/team" or str == "/íŒ€"
end
function ChatInput_IsInstantCommand_Alliance(str)
  return str == "/u" or str == "/ã…•" or str == "/alliance" or str == "/ì—°í•©"
end
