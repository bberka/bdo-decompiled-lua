...
function PaGlobal_ChatMain:getShowEmoticonInfo(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getShowEmoticonInfo panelIndex nil", "ì²œë§Œê¸°")
  return PaGlobal_ChatMain._emoticonInfo[panelIndex]
end
function PaGlobal_ChatMain:resetEmoticonInfo(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:resetEmoticonInfo panelIndex nil", "ì²œë§Œê¸°")
  PaGlobal_ChatMain._emoticonInfo[panelIndex] = nil
end
function PaGlobal_ChatMain:convertFromItemGradeColor(nameColorGrade)
  UI.ASSERT_NAME(nil ~= nameColorGrade, "PaGlobal_ChatMain:convertFromItemGradeColor nameColorGrade nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:createChattingContent(chattingMessage, poolCurrentUI, PosY, messageIndex, panelIndex, deltascrollPosy, cacheSimpleUI, chattingUpTime, skipCount)
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:createChattingContent chattingMessage nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:createChattingContent poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= PosY, "PaGlobal_ChatMain:createChattingContent PosY nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= messageIndex, "PaGlobal_ChatMain:createChattingContent messageIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:createChattingContent panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= deltascrollPosy, "PaGlobal_ChatMain:createChattingContent deltascrollPosy nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= cacheSimpleUI, "PaGlobal_ChatMain:createChattingContent cacheSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chattingUpTime, "PaGlobal_ChatMain:createChattingContent chattingUpTime nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= skipCount, "PaGlobal_ChatMain:createChattingContent skipCount nil", "ì²œë§Œê¸°")
  ...
  function contentsList:setShowAll(isShow)
    UI.ASSERT_NAME(nil ~= isShow, "contentsList:setShowAll isShow nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:uiPrivateChatType(chatType, chatting_Icon)
  UI.ASSERT_NAME(nil ~= chatType, "PaGlobal_ChatMain:uiPrivateChatType chatType nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatting_Icon, "PaGlobal_ChatMain:uiPrivateChatType chatting_Icon nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getMessageFontColor(msg)
  UI.ASSERT_NAME(nil ~= msg, "PaGlobal_ChatMain:getMessageFontColor msg nil", "ì²œë§Œê¸°")
  if nil == msg then
    return ""
  end
  local Message = msg
...
function PaGlobal_ChatMain:createContentWithMsgLength(reciver, poolCurrentUI, chatType, chattingMessage, isChattingAt, contentindex, chatting_contents, chatting_Icon, chatting_sender, msg, msgColor, msgstartindex, panelSizeX, chattingatNum, messageIndex, itemGradeColor, conetentsSizeY, recommand_Icon, chatting_GuildMark)
  UI.ASSERT_NAME(nil ~= reciver, "PaGlobal_ChatMain:createContentWithMsgLength reciver nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:createContentWithMsgLength poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatType, "PaGlobal_ChatMain:createContentWithMsgLength chatType nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:createContentWithMsgLength chattingMessage nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isChattingAt, "PaGlobal_ChatMain:createContentWithMsgLength isChattingAt nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= contentindex, "PaGlobal_ChatMain:createContentWithMsgLength contentindex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatting_contents, "PaGlobal_ChatMain:createContentWithMsgLength chatting_contents nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatting_Icon, "PaGlobal_ChatMain:createContentWithMsgLength chatting_Icon nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatting_sender, "PaGlobal_ChatMain:createContentWithMsgLength chatting_sender nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= msg, "PaGlobal_ChatMain:createContentWithMsgLength msg nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= msgColor, "PaGlobal_ChatMain:createContentWithMsgLength msgColor nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= msgstartindex, "PaGlobal_ChatMain:createContentWithMsgLength msgstartindex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelSizeX, "PaGlobal_ChatMain:createContentWithMsgLength panelSizeX nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chattingatNum, "PaGlobal_ChatMain:createContentWithMsgLength chattingatNum nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= messageIndex, "PaGlobal_ChatMain:createContentWithMsgLength messageIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= itemGradeColor, "PaGlobal_ChatMain:createContentWithMsgLength itemGradeColor nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= conetentsSizeY, "PaGlobal_ChatMain:createContentWithMsgLength conetentsSizeY nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= recommand_Icon, "PaGlobal_ChatMain:createContentWithMsgLength recommand_Icon nil", "ì„ìˆ˜í˜„")
  UI.ASSERT_NAME(nil ~= chatting_GuildMark, "PaGlobal_ChatMain:createContentWithMsgLength chatting_GuildMark nil", "ë°•ì„¸ì§„")
  local isLinkedItem = chattingMessage:isLinkedItem()
  local isLinkedGuild = chattingMessage:isLinkedGuild()
  local isLinkedPartyRecruit = chattingMessage:isLinkedPartyRecruit()
  local isLinkedWebSite = chattingMessage:isLinkedWebsite()
...
function HandleEventOnOut_MentalCard(index, isShow)
  UI.ASSERT_NAME(nil ~= index, "HandleEventOnOut_MentalCard index nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "HandleEventOnOut_MentalCard isShow nil", "ì²œë§Œê¸°")
...
function HandleEventLUp_MentalCard(mentalCardKey)
  UI.ASSERT_NAME(nil ~= mentalCardKey, "HandleEventLUp_MentalCard mentalCardKey nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getTextLimitWidth(chatting_contents, msgOrigin)
  UI.ASSERT_NAME(nil ~= chatting_contents, "PaGlobal_ChatMain:getTextLimitWidth chatting_contents nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= msgOrigin, "PaGlobal_ChatMain:getTextLimitWidth msgOrigin nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getCheckItemWebAt(chattingMessage, chattingatNum, drawstart, drawend)
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:getCheckItemWebAt chattingMessage nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chattingatNum, "PaGlobal_ChatMain:getCheckItemWebAt chattingatNum nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawstart, "PaGlobal_ChatMain:getCheckItemWebAt drawstart nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawend, "PaGlobal_ChatMain:getCheckItemWebAt drawend nil", "ì²œë§Œê¸°")
  local isLinkedItem = chattingMessage:isLinkedItem()
  local isLinkedGuild = chattingMessage:isLinkedGuild()
  local isLinkedPartyRecruit = chattingMessage:isLinkedPartyRecruit()
  local isLinkedWebSite = chattingMessage:isLinkedWebsite()
...
function PaGlobal_ChatMain:getLineSizeCheck(chattingMessage, poolCurrentUI, PosY, messageIndex, panelIndex)
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:getLineSizeCheck chattingMessage nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getLineSizeCheck poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= PosY, "PaGlobal_ChatMain:getLineSizeCheck PosY nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= messageIndex, "PaGlobal_ChatMain:getLineSizeCheck messageIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getLineSizeCheck panelIndex nil", "ì²œë§Œê¸°")
  local panelSizeX = poolCurrentUI._list_PanelBG[0]:GetSizeX() - 20
  local panelSizeY = poolCurrentUI._list_PanelBG[0]:GetSizeY()
  local emoticonCount = chattingMessage:getEmoticonCount()
  local chatType = chattingMessage.chatType
...
function PaGlobal_ChatMain:getSenderString(chattingMessage)
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:getSenderString chattingMessage nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:setChattingIcon(chatType, chatting_Icon, panelIndex)
  UI.ASSERT_NAME(nil ~= chatType, "PaGlobal_ChatMain:setChattingIcon chatType nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatting_Icon, "PaGlobal_ChatMain:setChattingIcon chatting_Icon nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:setchattingSender(chatType, chatRoomNo, chatting_sender, chatting_Icon, senderStr, msgColor, recommand_Icon, chattingMessage)
  UI.ASSERT_NAME(nil ~= chatType, "PaGlobal_ChatMain:setchattingSender chatType nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatRoomNo, "PaGlobal_ChatMain:setchattingSender chatRoomNo nil", "ê¹€ì§€í˜")
  UI.ASSERT_NAME(nil ~= chatting_sender, "PaGlobal_ChatMain:setchattingSender chatting_sender nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatting_Icon, "PaGlobal_ChatMain:setchattingSender chatting_Icon nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= senderStr, "PaGlobal_ChatMain:setchattingSender senderStr nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= msgColor, "PaGlobal_ChatMain:setchattingSender msgColor nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= recommand_Icon, "PaGlobal_ChatMain:setchattingSender recommand_Icon nil", "ì„ìˆ˜í˜„")
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:setchattingSender chattingMessage nil", "ì„ìˆ˜í˜„")
  local chat_contentAddPosX = 0
...
function PaGlobal_ChatMain:setChattingGuildMark(chatting_GuildMark, chattingMessage, chatting_sender, isShow)
  UI.ASSERT_NAME(nil ~= chatting_GuildMark, "PaGlobal_ChatMain:setChattingGuildMark chatting_GuildMark nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:setChattingGuildMark chattingMessage nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chatting_sender, "PaGlobal_ChatMain:setChattingGuildMark chatting_sender nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getChattingMessage(panelIndex, chattingMessage)
  ...
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getChattingMessage panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chattingMessage, "PaGlobal_ChatMain:getChattingMessage chattingMessage nil", "ì²œë§Œê¸°")
  local chatType = chattingMessage.chatType
...
function PaGlobal_ChatMain:getIsShowTimeString(index)
  ...
  if nil == chatPanel then
    _PA_ASSERT(false, "ì—†ëŠ” ë²ˆí˜¸ì˜ ì±„íŒ… íŒ¨ë„ì…ë‹ˆë‹¤.(" .. tostring(index) .. ")")
    return false
  end
  return chatPanel:getIsShowTimeString()
end
function PaGlobal_ChatMain:getRecommandIconSizeX(recommand_Icon)
  UI.ASSERT_NAME(nil ~= recommand_Icon, "PaGlobal_ChatMain:getChattingMessage recommand_Icon nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getRecommandGradeIndex(thumbsUpGrade)
  UI.ASSERT_NAME(nil ~= thumbsUpGrade, "PaGlobal_ChatMain:getChattingMessage thumbsUpGrade nil", "ê¹€ì§€í˜")
