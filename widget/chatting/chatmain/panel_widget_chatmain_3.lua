...
function PaGlobal_ChatMain:createPanel(poolIndex, stylePanel)
  UI.ASSERT_NAME(nil ~= poolIndex, "chatUIPool:createPanel poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= stylePanel, "chatUIPool:createPanel stylePanel nil", "ì²œë§Œê¸°")
  local panel
  if 0 == poolIndex then
...
function PaGlobal_ChatMain:createPool(poolIndex, poolStylePanel, poolParentPanel)
  UI.ASSERT_NAME(nil ~= poolIndex, "chatUIPool:createPool poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= poolStylePanel, "chatUIPool:createPool poolStylePanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= poolParentPanel, "chatUIPool:createPool poolParentPanel nil", "ì²œë§Œê¸°")
  local chatUIPool = {
    _list_PanelBG = {},
    _list_TitleTab = {},
    _list_TitleTabText = {},
  ...
  function chatUIPool:prepareControl(Panel, parentControl, createdCotrolList, controlType, controlName, createCount)
    UI.ASSERT_NAME(nil ~= Panel, "chatUIPool:prepareControl Panel nil", "ì²œë§Œê¸°")
    UI.ASSERT_NAME(nil ~= parentControl, "chatUIPool:prepareControl parentControl nil", "ì²œë§Œê¸°")
    UI.ASSERT_NAME(nil ~= createdCotrolList, "chatUIPool:prepareControl createdCotrolList nil", "ì²œë§Œê¸°")
    UI.ASSERT_NAME(nil ~= controlType, "chatUIPool:prepareControl controlType nil", "ì²œë§Œê¸°")
    UI.ASSERT_NAME(nil ~= controlName, "chatUIPool:prepareControl controlName nil", "ì²œë§Œê¸°")
    UI.ASSERT_NAME(nil ~= createCount, "chatUIPool:prepareControl createCount nil", "ì²œë§Œê¸°")
  ...
  function chatUIPool:initialize(stylePanel, parentControl, poolIndex)
    UI.ASSERT_NAME(nil ~= stylePanel, "chatUIPool:initialize stylePanel nil", "ì²œë§Œê¸°")
    UI.ASSERT_NAME(nil ~= parentControl, "chatUIPool:initialize parentControl nil", "ì²œë§Œê¸°")
    UI.ASSERT_NAME(nil ~= poolIndex, "chatUIPool:initialize poolIndex nil", "ì²œë§Œê¸°")
  ...
  function PaGlobal_getChattingIconByIndex(index)
    UI.ASSERT_NAME(nil ~= index, "PaGlobal_getChattingIconByIndex index nil", "ì²œë§Œê¸°")
    return chatUIPool:getChattingIconByIndex(index)
  end
  function chatUIPool:getChattingIconByIndex(index)
    UI.ASSERT_NAME(nil ~= index, "chatUIPool:getChattingIconByIndex index nil", "ì²œë§Œê¸°")
    return chatUIPool._list_ChattingIcon[index]
  end
  function chatUIPool:getRecommandIconByIndex(index)
    UI.ASSERT_NAME(nil ~= index, "chatUIPool:getRecommandIconByIndex index nil", "ì²œë§Œê¸°")
    return chatUIPool._list_RecommandIcon[index]
  end
  function chatUIPool:newChattingSender(messageIndex, index)
    UI.ASSERT_NAME(nil ~= messageIndex, "chatUIPool:newChattingSender messageIndex nil", "ì²œë§Œê¸°")
    if nil == index then
  ...
  function PaGlobal_getChattingContentsByIndex(index)
    UI.ASSERT_NAME(nil ~= index, "PaGlobal_getChattingContentsByIndex index nil", "ì²œë§Œê¸°")
    return chatUIPool._list_ChattingContents[index]
  end
  function chatUIPool:newChattingLinkedItem(messageIndex, index)
    UI.ASSERT_NAME(nil ~= messageIndex, "chatUIPool:newChattingLinkedItem messageIndex nil", "ì²œë§Œê¸°")
    if nil == index then
  ...
  function chatUIPool:newChattingLinkedGuild(messageIndex)
    UI.ASSERT_NAME(nil ~= messageIndex, "chatUIPool:newChattingLinkedGuild messageIndex nil", "ì²œë§Œê¸°")
  ...
  function chatUIPool:newChattingLinkedParty(messageIndex)
    UI.ASSERT_NAME(nil ~= messageIndex, "chatUIPool:newChattingLinkedParty messageIndex nil", "ê°œë°œì")
  ...
  function PaGlobal_getChattingGuildMarkByIndex(index)
    UI.ASSERT_NAME(nil ~= index, "PaGlobal_getChattingGuildMarkByIndex index nil", "ì²œë§Œê¸°")
    return chatUIPool:getChattingGuildMarkByIndex(index)
  end
  function chatUIPool:getChattingGuildMarkByIndex(index)
    UI.ASSERT_NAME(nil ~= index, "chatUIPool:getChattingGuildMarkByIndex index nil", "ì²œë§Œê¸°")
    return chatUIPool._list_ChattingGuildMark[index]
  end
  ...
  function chatUIPool:newChattingLinkedWebSite(messageIndex)
    UI.ASSERT_NAME(nil ~= messageIndex, "chatUIPool:newChattingLinkedWebSite messageIndex nil", "ì²œë§Œê¸°")
...
function Chatting_ScrollEvent(poolIndex, updown)
  UI.ASSERT_NAME(nil ~= poolIndex, "Chatting_ScrollEvent poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= updown, "Chatting_ScrollEvent updown nil", "ì²œë§Œê¸°")
...
function HandleEventLUp_ChattingSender(poolIndex, senderStaticIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "HandleEventLUp_ChattingSender poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= senderStaticIndex, "HandleEventLUp_ChattingSender senderStaticIndex nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:isInviteParty(chatType, isSameChannel)
  UI.ASSERT_NAME(nil ~= chatType, "PaGlobal_ChatMain:isInviteParty chatType nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSameChannel, "PaGlobal_ChatMain:isInviteParty isSameChannel nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:isInviteGuild(chatType, isSameChannel)
  UI.ASSERT_NAME(nil ~= chatType, "PaGlobal_ChatMain:isInviteGuild chatType nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSameChannel, "PaGlobal_ChatMain:isInviteGuild isSameChannel nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:isInviteCompetition(isSameChannel)
  UI.ASSERT_NAME(nil ~= isSameChannel, "PaGlobal_ChatMain:isInviteCompetition isSameChannel nil", "ì²œë§Œê¸°")
  local selfPlayer = getSelfPlayer()
  local selfActorKeyRaw = selfPlayer:getActorKey()
  return isSameChannel and ToClient_IsCompetitionHost()
end
function PaGlobal_ChatMain:isRecommand(chatType, chatRoomNo)
  UI.ASSERT_NAME(nil ~= chatType, "PaGlobal_ChatMain:isRecommand chatType nil", "ë°•ì„±ì€")
  UI.ASSERT_NAME(nil ~= chatRoomNo, "PaGlobal_ChatMain:isRecommand chatRoomNo nil", "ê¹€ì§€í˜")
...
function HandleOn_ChattingLinkedWebSite(poolIndex, LinkedWebsiteIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "HandleOn_ChattingLinkedWebSite poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= LinkedWebsiteIndex, "HandleOn_ChattingLinkedWebSite LinkedWebsiteIndex nil", "ì²œë§Œê¸°")
  FromClient_ChatUpdate()
...
function HandleOn_ChattingLinkedGuild(poolIndex, LinkedGuildIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "HandleOn_ChattingLinkedGuild poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= LinkedGuildIndex, "HandleOn_ChattingLinkedGuild LinkedGuildIndex nil", "ì²œë§Œê¸°")
  FromClient_ChatUpdate()
  PaGlobal_ChatMain._linkedItemTooltipIsClicked = isClicked
  local paramIndex = poolIndex
  if 0 == poolIndex then
...
function HandleOn_ChattingLinkedParty(poolIndex, LinkedPartyIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "HandleOn_ChattingLinkedParty poolIndex nil", "ê°œë°œì")
  UI.ASSERT_NAME(nil ~= LinkedPartyIndex, "HandleOn_ChattingLinkedParty LinkedPartyIndex nil", "ê°œë°œì")
  FromClient_ChatUpdate()
  PaGlobal_ChatMain._linkedItemTooltipIsClicked = isClicked
  local paramIndex = poolIndex
  if 0 == poolIndex then
...
function HandleOn_ChattingLinkedItem(poolIndex, LinkedItemStaticIndex, isClicked)
  UI.ASSERT_NAME(nil ~= poolIndex, "HandleOn_ChattingLinkedItem poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= LinkedItemStaticIndex, "HandleOn_ChattingLinkedItem LinkedItemStaticIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isClicked, "HandleOn_ChattingLinkedItem isClicked nil", "ì²œë§Œê¸°")
  FromClient_ChatUpdate()
  PaGlobal_ChatMain._linkedItemTooltipIsClicked = isClicked
  local paramIndex = poolIndex
  if 0 == poolIndex then
...
function PaGlobal_ChatMain:getPool(poolIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "PaGlobal_ChatMain:getPool poolIndex nil", "ì²œë§Œê¸°")
  return PaGlobal_ChatMain._listChatUIPool[poolIndex]
end
function PaGlobal_ChatMain:getPanel(poolIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "PaGlobal_ChatMain:getPanel poolIndex nil", "ì²œë§Œê¸°")
  return PaGlobal_ChatMain._listPanel[poolIndex]
end
function PaGlobal_ChatMain:getPopupNameMenu(poolIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "PaGlobal_ChatMain:getPopupNameMenu poolIndex nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getMainTab(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getMainTab poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getMainTab panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getMainTab drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getMainTab isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getMainTab isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getMainTab isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getSettingButton(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getSettingButton poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getSettingButton panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getSettingButton drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getSettingButton isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getSettingButton isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getSettingButton isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getDivisionButton(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getDivisionButton poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getDivisionButton panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getDivisionButton drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getDivisionButton isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getDivisionButton isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getDivisionButton isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getDeleteButton(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getDeleteButton poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getDeleteButton panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getDeleteButton drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getDeleteButton isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getDeleteButton isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getDeleteButton isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getCombineButton(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getCombineButton poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getCombineButton panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getCombineButton drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getCombineButton isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getCombineButton isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getCombineButton isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getScrollResetButton(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getScrollResetButton poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getScrollResetButton panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getScrollResetButton drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getScrollResetButton isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getScrollResetButton isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getScrollResetButton isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getMoreList(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getMoreList poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getMoreList panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getMoreList drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getMoreList isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getMoreList isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getMoreList isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getSubTab(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getSubTab poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getSubTab panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getSubTab drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getSubTab isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getSubTab isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getSubTab isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getPanelResizeButton(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getPanelResizeButton poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getPanelResizeButton panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getPanelResizeButton drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getPanelResizeButton isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getPanelResizeButton isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getPanelResizeButton isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getPanelBg(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getPanelBg poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getPanelBg panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getPanelBg drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getPanelBg isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getPanelBg isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getPanelBg isSimpleUI nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getPanelScroll(poolCurrentUI, panelIndex, drawPanelIndex, isShow, isEnableSimpleUI, isSimpleUI)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:getPanelScroll poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getPanelScroll panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:getPanelScroll drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:getPanelScroll isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isEnableSimpleUI, "PaGlobal_ChatMain:getPanelScroll isEnableSimpleUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isSimpleUI, "PaGlobal_ChatMain:getPanelScroll isSimpleUI nil", "ì²œë§Œê¸°")
