...
function HandleOn_ChattingAddTabToolTip(isShow, poolIndex, tipType)
  UI.ASSERT_NAME(nil ~= isShow, "HandleOn_ChattingAddTabToolTip isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= poolIndex, "HandleOn_ChattingAddTabToolTip poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= tipType, "HandleOn_ChattingAddTabToolTip tipType nil", "ì²œë§Œê¸°")
  if not isShow then
    TooltipSimple_Hide()
    return
  end
...
function HandleClicked_Chatting_ResizeStartPos(drawPanelIndex)
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "HandleClicked_Chatting_ResizeStartPos drawPanelIndex nil", "ì²œë§Œê¸°")
...
function HandleClicked_Chatting_Resize(drawPanelIndex, panelIdx)
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "HandleClicked_Chatting_Resize drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIdx, "HandleClicked_Chatting_Resize panelIdx nil", "ì²œë§Œê¸°")
  local panel = PaGlobal_ChatMain:getPanel(drawPanelIndex)
...
function Chatting_PanelTransparency(panelIndex, transparency, isHideTooltip)
  UI.ASSERT_NAME(nil ~= panelIndex, "Chatting_PanelTransparency panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= transparency, "Chatting_PanelTransparency transparency nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isHideTooltip, "Chatting_PanelTransparency isHideTooltip nil", "ì²œë§Œê¸°")
...
function HandleClicked_Chatting_ResizeStartPosEND(drawPanelIndex)
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "HandleClicked_Chatting_ResizeStartPosEND drawPanelIndex nil", "ì²œë§Œê¸°")
  ToClient_SaveUiInfo(false)
  Chatting_PanelTransparency(drawPanelIndex, false, false)
end
function HandleClicked_ScrollBtnPosY(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_ScrollBtnPosY panelIndex nil", "ì²œë§Œê¸°")
...
function Chatting_Transparency(index)
  UI.ASSERT_NAME(nil ~= index, "Chatting_Transparency index nil", "ì²œë§Œê¸°")
  if index < 0 then
    return
  end
...
function HandleClicked_Chatting_Division(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_Chatting_Division panelIndex nil", "ì²œë§Œê¸°")
...
function HandleClicked_Chatting_Close(panelIndex, drawPanelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_Chatting_Close panelIndex nil", "ì²œë§Œê¸°")
  ToClient_closeChattingPanel(panelIndex)
  if true == ToClient_isContentsOpenNewChatMain() then
    if 0 ~= drawPanelIndex then
      PaGlobal_ChatMain._isMouseOn = false
      local panel = PaGlobal_ChatMain:getPanel(drawPanelIndex)
      _PA_ASSERT(nil ~= panel, "ë‹«ì„ íŒ¨ë„ì´ ì—†ìŠµë‹ˆë‹¤. DrawPanelIndex = " .. tostring(drawPanelIndex))
      panel:SetShow(false)
    else
      PaGlobal_ChatMain._mainPanelSelectPanelIndex = 0
      PaGlobal_ChatMain:updatePanel(0, true)
...
function HandleClicked_Chatting_ScrollReset(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_Chatting_ScrollReset panelIndex nil", "ì²œë§Œê¸°")
...
function HandleClicked_Chatting_ChangeTab_Old(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_Chatting_ChangeTab panelIndex nil", "ì²œë§Œê¸°")
  PaGlobal_ChatMain._mainPanelSelectPanelIndex = panelIndex
  TooltipSimple_Hide()
  FromClient_ChatUpdate(true, nil, true)
end
function HandleClicked_Chatting_ChangeTab_New(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_Chatting_ChangeTab panelIndex nil", "ë°•ê·œë‚˜")
...
function HandleClicked_Chatting_CombineTab(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_Chatting_CombineTab panelIndex nil", "ì²œë§Œê¸°")
...
function HandleEventOn_ChatMainPanelTransparency(panelIndex, isHideTooltip)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleEventOn_ChatMainPanelTransparency panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isHideTooltip, "HandleEventOn_ChatMainPanelTransparency isHideTooltip nil", "ì²œë§Œê¸°")
...
function HandleEventOut_ChatMainPanelTransparency(panelIndex, isHideTooltip)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleEventOut_ChatMainPanelTransparency panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isHideTooltip, "HandleEventOut_ChatMainPanelTransparency isHideTooltip nil", "ì²œë§Œê¸°")
...
function HandleOn_ChattingEmoticon(poolIndex, emoticonIndex, EmoticonKey, isShow, isReset)
  UI.ASSERT_NAME(nil ~= poolIndex, "HandleOn_ChattingEmoticon poolIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= emoticonIndex, "HandleOn_ChattingEmoticon emoticonIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= EmoticonKey, "HandleOn_ChattingEmoticon EmoticonKey nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "HandleOn_ChattingEmoticon isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isReset, "HandleOn_ChattingEmoticon isReset nil", "ì²œë§Œê¸°")
...
function HandleClicked_Chatting_AddTabByIndex(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "HandleClicked_Chatting_AddTabByIndex panelIndex nil", "ì²œë§Œê¸°")
...
function HandleOn_Chatting_RecommandTooltip(recommandCount)
  UI.ASSERT_NAME(nil ~= recommandCount, "HandleOn_Chatting_RecommandTooltip recommandCount nil", "ê¹€ì§€í˜")
...
function PaGlobal_ChatMain:getScrollSpeed(wheelScrollingTime)
  UI.ASSERT_NAME(nil ~= wheelScrollingTime, "PaGlobal_ChatMain:getScrollSpeed wheelScrollingTime nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getAddMessageCountLine(panelIndex, addMessageCount)
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getAddMessageCountLine panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= addMessageCount, "PaGlobal_ChatMain:getAddMessageCountLine addMessageCount nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:addMessageScrollCount(panelIndex, addMessageCount)
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:addMessageScrollCount panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= addMessageCount, "PaGlobal_ChatMain:addMessageScrollCount addMessageCount nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:getCheckAddMessageCount(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:getCheckAddMessageCount chatPanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:getCheckAddMessageCount panelIndex nil", "ì²œë§Œê¸°")
...
function HandleClicked_Chatting_Recommand(senderUserNo, chatType)
  UI.ASSERT_NAME(nil ~= senderUserNo, "HandleClicked_Chatting_Recommand senderUserNo nil", "ì„ìˆ˜í˜„")
  UI.ASSERT_NAME(nil ~= chatType, "HandleClicked_Chatting_Recommand chatType nil", "ê¹€ì§€í˜")
