...
function PaGlobal_ChatMain:update_Old(chatPanel, panelIndex, forceUpdate)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:update chatPanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:update panelIndex nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:checkUpdate(chatPanel, panelIndex, forceUpdate)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:update chatPanel nil", "ë°•ê·œë‚˜")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:update panelIndex nil", "ë°•ê·œë‚˜")
  UI.ASSERT_NAME(nil ~= PaGlobal_ChatMain._mainPanelSelectPanelIndex, "ë¹„ì •ìƒì…ë‹ˆë‹¤.", "ë°•ê·œë‚˜")
  if false == chatPanel:isUpdated() and true ~= forceUpdate then
    return false
  end
  if nil == getSelfPlayer() or nil == getSelfPlayer():get() then
...
function PaGlobal_ChatMain:tabUpdate(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:tabUpdate chatPanelì´ nilì´ë©´ ì•ˆ ë©ë‹ˆë‹¤.", "ìš°ì •ë¬´")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:tabUpdate panelIndexì´ nilì´ë©´ ì•ˆ ë©ë‹ˆë‹¤.", "ìš°ì •ë¬´")
...
function PaGlobal_ChatMain:poolUpdate(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:poolUpdate chatPanelì´ nilì´ë©´ ì•ˆ ë©ë‹ˆë‹¤.", "ìš°ì •ë¬´")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:poolUpdate panelIndexì´ nilì´ë©´ ì•ˆ ë©ë‹ˆë‹¤.", "ìš°ì •ë¬´")
  local isCombinedMainPanel = chatPanel:isCombinedToMainPanel()
  local drawPanelIndex = panelIndex
  if true == isCombinedMainPanel then
    drawPanelIndex = 0
...
function PaGlobal_ChatMain:scrollUpdate(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:scrollUpdateì˜ chatPanelì´ nilì´ë©´ ì•ˆ ë©ë‹ˆë‹¤.", "ìš°ì •ë¬´")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:scrollUpdateì˜ panelIndexì´ nilì´ë©´ ì•ˆ ë©ë‹ˆë‹¤.", "ìš°ì •ë¬´")
...
function PaGlobal_ChatMain:addTabCheck(currentPanelIndex)
  if ToClient_getOpenChattingPanelCount() < __eChatPanelMaxCount then
    ...
    if nil == panel_addTab then
      UI.ASSERT_NAME(nil ~= panel_addTab, "PaGlobal_ChatMain:addTabCheck panel_addTabì´ nilì´ë©´ ì•ˆ ë©ë‹ˆë‹¤.", "ìš°ì •ë¬´")
      return
    end
...
function PaGlobal_ChatMain:createTab(poolCurrentUI, panelIndex, isActivePanel, drawPanelIndex, isCombinedMainPanel, PosX, isShow)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "PaGlobal_ChatMain:createTab poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:createTab panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isActivePanel, "PaGlobal_ChatMain:createTab isActivePanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:createTab drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isCombinedMainPanel, "PaGlobal_ChatMain:createTab isCombinedMainPanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= PosX, "PaGlobal_ChatMain:createTab PosX nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_ChatMain:createTab isShow nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:chattingPoolUpdate(poolCurrentUI, currentPanel, panelIndex, drawPanelIndex, isShow, bgAlpha, isClear)
  UI.ASSERT_NAME(nil ~= poolCurrentUI, "ChattingPoolUpdate poolCurrentUI nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= currentPanel, "ChattingPoolUpdate currentPanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "ChattingPoolUpdate panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "ChattingPoolUpdate drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isShow, "ChattingPoolUpdate isShow nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= bgAlpha, "ChattingPoolUpdate bgAlpha nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isClear, "ChattingPoolUpdate isClear nil", "ì²œë§Œê¸°")
...
function ChattingViewManager_UpdatePerFrame(deltaTime)
  UI.ASSERT_NAME(nil ~= deltaTime, "ChattingViewManager_UpdatePerFrame deltaTime nil", "ì²œë§Œê¸°")
...
function moveChatTab(isMoveTo)
  UI.ASSERT_NAME(nil ~= isMoveTo, "moveChatTab isMoveTo nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:moveChatTabExec(isMoveTo)
  UI.ASSERT_NAME(nil ~= isMoveTo, "PaGlobal_ChatMain:moveChatTabExec isMoveTo nil", "ì²œë§Œê¸°")
  local isSuccess = false
  local addIndex = 1
...
function FGlobal_getChattingPanel(poolIndex)
  UI.ASSERT_NAME(nil ~= poolIndex, "FGlobal_getChattingPanel poolIndex nil", "ì²œë§Œê¸°")
  return PaGlobal_ChatMain:getPanel(poolIndex)
end
function FGlobal_getChattingPanelUIPool(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "FGlobal_getChattingPanelUIPool panelIndex nil", "ì²œë§Œê¸°")
  return PaGlobal_ChatMain:getPool(panelIndex)
end
function Chatting_setUsedSmoothChattingUp(flag)
  UI.ASSERT_NAME(nil ~= flag, "Chatting_setUsedSmoothChattingUp flag nil", "ì²œë§Œê¸°")
...
function Chatting_setIsOpenValue(panelIndex, isOpen)
  UI.ASSERT_NAME(nil ~= panelIndex, "Chatting_setIsOpenValue panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isOpen, "Chatting_setIsOpenValue isOpen nil", "ì²œë§Œê¸°")
  local chatPanel = ToClient_getChattingPanel(panelIndex)
...
function FGlobal_Chatting_PanelTransparency_Chk(panelIndex)
  UI.ASSERT_NAME(nil ~= panelIndex, "FGlobal_Chatting_PanelTransparency_Chk panelIndex nil", "ì²œë§Œê¸°")
...
function FGlobal_Chatting_PanelTransparency(panelIndex, _transparency, isUpdate)
  UI.ASSERT_NAME(nil ~= panelIndex, "FGlobal_Chatting_PanelTransparency panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= _transparency, "FGlobal_Chatting_PanelTransparency _transparency nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= isUpdate, "FGlobal_Chatting_PanelTransparency isUpdate nil", "ì²œë§Œê¸°")
...
function PaGlobalFunc_isItemEmticon(EmoticonKey)
  UI.ASSERT_NAME(nil ~= EmoticonKey, "PaGlobalFunc_isItemEmticon EmoticonKey nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:updateChatMessage(chatPanel, panelIndex, drawPanelIndex, chattingUpTime)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:updateChatMessage chatPanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:updateChatMessage panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= drawPanelIndex, "PaGlobal_ChatMain:updateChatMessage drawPanelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= chattingUpTime, "PaGlobal_ChatMain:updateChatMessage chattingUpTime nil", "ì²œë§Œê¸°")
  local poolCurrentUI = PaGlobal_ChatMain:getPool(drawPanelIndex)
  local currentPanel = PaGlobal_ChatMain:getPanel(drawPanelIndex)
...
function PaGlobal_ChatMain:UpdateSmoothChattingContent(chattingUpTime)
  UI.ASSERT_NAME(nil ~= chattingUpTime, "PaGlobal_ChatMain:UpdateSmoothChattingContent chattingUpTime nil", "ì²œë§Œê¸°")
  FromClient_ChatUpdate(true)
  local count = ToClient_getChattingPanelCount()
...
function PaGlobal_ChatMain:updateSmoothChatting(chatPanel, panelIndex)
  UI.ASSERT_NAME(nil ~= chatPanel, "PaGlobal_ChatMain:updateSmoothChatting chatPanel nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_ChatMain:updateSmoothChatting panelIndex nil", "ì²œë§Œê¸°")
...
function PaGlobal_ChatMain:UpdateSmoothResetScrollContent(chattingScrollingTime)
  UI.ASSERT_NAME(nil ~= chattingScrollingTime, "PaGlobal_ChatMain:UpdateSmoothResetScrollContent chattingScrollingTime nil", "ì²œë§Œê¸°")
  FromClient_ChatUpdate(true)
  local count = ToClient_getChattingPanelCount()
  for panelIndex = 0, count - 1 do
    local chatPanel = ToClient_getChattingPanel(panelIndex)
...
function PaGlobal_ChatMain:UpdateSmoothWheelScrollContent(wheelScrollingTime)
  UI.ASSERT_NAME(nil ~= wheelScrollingTime, "PaGlobal_ChatMain:UpdateSmoothWheelScrollContent wheelScrollingTime nil", "ì²œë§Œê¸°")
  if true == ToClient_isContentsOpenNewChatMain() then
...
function PaGlobal_ChatMain:UpdateSmoothWheelScrollContent_New(wheelScrollingTime)
  _PA_ASSERT(nil ~= self._scrollIndex, "ë¹„ì •ìƒì…ë‹ˆë‹¤.")
...
function PaGlobal_Chat_UpdatTopClipingPanel(panelIndex, addClipSizeY)
  UI.ASSERT_NAME(nil ~= panelIndex, "PaGlobal_Chat_UpdatTopClipingPanel panelIndex nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= addClipSizeY, "PaGlobal_Chat_UpdatTopClipingPanel addClipSizeY nil", "ì²œë§Œê¸°")
  local chatPanel = ToClient_getChattingPanel(panelIndex)
  if false == chatPanel:isOpen() then
    return
  end
