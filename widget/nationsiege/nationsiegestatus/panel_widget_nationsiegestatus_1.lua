...
function PaGlobal_NationSiegeStatus:registEventHandler()
  if nil == Panel_Widget_NationSiegeStatus then
    UI_ASSERT_NAME(nil ~= Panel_Widget_NationSiegeStatus, "PaGlobal_NationSiegeStatus:registEventHandler", "ì²œë§Œê¸°")
    return
  end
...
function PaGlobal_NationSiegeStatus:open()
  if nil == Panel_Widget_NationSiegeStatus then
    UI_ASSERT_NAME(nil ~= Panel_Widget_NationSiegeStatus, "PaGlobal_NationSiegeStatus:open", "ì²œë§Œê¸°")
    return
  end
...
function PaGlobal_NationSiegeStatus:close()
  if nil == Panel_Widget_NationSiegeStatus then
    UI_ASSERT_NAME(nil ~= Panel_Widget_NationSiegeStatus, "PaGlobal_NationSiegeStatus:close", "ì²œë§Œê¸°")
    return
  end
