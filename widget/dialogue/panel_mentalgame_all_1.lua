...
function PaGlobal_MentalGame_All:prepareOpen()
  ...
  if false == show_MentalGame() then
    _PA_ASSERT_NAME(false, "PaGlobal_MentalGame_All:prepareOpen() : ì´ì•¼ê¸° êµë¥˜ê°€ ì •ìƒì ìœ¼ë¡œ ì—´ë¦¬ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤.", "ì •ì§€í˜œ")
  end
  self._gameStep = 0
...
function PaGlobal_MentalGame_All:insertCircleLineAndObject()
  ...
  MentalKnowledgeBase.color = float4(0,117647058823529, 0,819607843137255, 0,992156862745098, 0,3)
  MentalKnowledgeBase.arrowColor = float4(0,117647058823529, 0,819607843137255, 0,992156862745098, 0,3)
