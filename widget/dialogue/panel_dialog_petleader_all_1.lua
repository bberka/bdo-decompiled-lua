function PaGlobal_DialogPetLeader_All:initialize()
  ...
  self._ui_console.stc_KeyGuideBG = UI.getChildControl(Panel_Dialog_PetLeader_All, "Static_BottomBG_ConsoleUI")
  ...
  if self._isConsole == true then
    Panel_Dialog_PetLeader_All:SetSize(Panel_Dialog_PetLeader_All:GetSizeX(), Panel_Dialog_PetLeader_All:GetSizeY() - self._ui_pc.btn_Training:GetSizeY())
    self._ui.txt_DescBox:SetPosY(self._ui.txt_DescBox:GetPosY() - self._ui_pc.btn_Training:GetSizeY())
    self._ui_console.stc_KeyGuideBG:SetPosY(self._ui_console.stc_KeyGuideBG:GetPosY() + 5)
  end
