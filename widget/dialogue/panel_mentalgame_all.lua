PaGlobal_MentalGame_All = {
  ...
  _operatorString = {
    ...
    [CppEnums.DlgCommonConditionOperatorType.Large] = "<PAColor0xFFFF0000>â–²<PAOldColor>",
    [CppEnums.DlgCommonConditionOperatorType.Small] = "<PAColor0xFF0000FF>â–¼<PAOldColor>"
  },
