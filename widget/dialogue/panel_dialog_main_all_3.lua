...
function FromClient_DialogFunctionClick_Contents_OldMoonSmelting()
  if nil ~= PaGlobal_OldMoonSmelting then
    PaGlobalFunc_OldMoonSmelting_Open()
  end
end
...
function PreClose_ReinforceSkill()
  if true == _ContentsGroup_NewUI_ReinforceSkill_All then
    if PaGlobalFunc_PaGlobal_ReinforceSkill_All_Close ~= nil then
      PaGlobalFunc_PaGlobal_ReinforceSkill_All_Close()
    end
    if PaGlobalFunc_PaGlobal_SkillReinforce_All_Close ~= nil then
