...
function PaGlobalFunc_MaidList_All_SelectMaid(key32)
  ...
  if nil == key32 then
    _PA_ASSERT_NAME(false, "PaGlobalFunc_MaidList_All_SelectMaid: key32ì´ nilì…ë‹ˆë‹¤.", "ì •ì§€í˜œ")
    return
  end
  local selfProxy = getSelfPlayer()
  if nil == selfProxy then
    _PA_ASSERT_NAME(false, "PaGlobalFunc_MaidList_All_SelectMaid: selfProxy nilì…ë‹ˆë‹¤", "ì •ì§€í˜œ")
    return
  end
