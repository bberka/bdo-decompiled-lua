...
function PadEventRBLB_PaGlobal_MaidList_All_NextTab(val)
  ...
  if nil == val then
    _PA_ASSERT_NAME(false, "HandleEventLUp_MaidList_All_Update:ì˜ëª»ëœ val ê°’ì…ë‹ˆë‹¤.", "ì •ì§€í˜œ")
    return
  end
...
function HandleEventLUp_MaidList_All_Update(index)
  ...
  if nil == index then
    _PA_ASSERT_NAME(false, "HandleEventLUp_MaidList_All_Update:ì˜ëª»ëœ index ê°’ì…ë‹ˆë‹¤.", "ì •ì§€í˜œ")
    return
  end
