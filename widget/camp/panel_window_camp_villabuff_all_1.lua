function PaGlobal_BuildingBuff_All:initialize()
  ...
  self._ui._txt_Money = UI.getChildControl(self._ui._rdo_Money, "StaticText_Money")
  self._ui._txt_Money2 = UI.getChildControl(self._ui._rdo_Money2, "StaticText_Money2")
  ...
  self._ui._rdo_Money:SetSize(basePanelSizeX / 2 - 15 + wideSizeX / 2, self._ui._rdo_Money:GetSizeY())
  self._ui._rdo_Money2:SetSize(basePanelSizeX / 2 - 15 + wideSizeX / 2, self._ui._rdo_Money2:GetSizeY())
  ...
  self._ui._stc_BottomGroup:SetSize(basePanelSizeX + wideSizeX, self._ui._rdo_Money:GetSizeY() + self._ui._txt_DescBG:GetSizeY() + 20)
  ...
  self._ui._rdo_Money:ComputePos()
  self._ui._rdo_Money2:ComputePos()
  self._ui._txt_Money:ComputePos()
  self._ui._txt_Money2:ComputePos()
  ...
  for index = 0, self._maxPriceKey - 1 do
    ...
    for buffIndex = 0, buffMaxCount - 1 do
      ...
      if nil ~= skillWrapper then
        ...
        tempDesc[self._totalBuffCount] = string.gsub(string.lower(skillWrapper:getDescription()), "ï¼Œ", "")
      end
      ...
      for ii = 0, self._sortCount do
        for jj = 0, #self._sortTable[ii] - 1 do
          ...
          if nil ~= skillWrapper then
            ...
            local buffDesc = string.gsub(string.lower(skillWrapper:getDescription()), "ï¼Œ", "")
