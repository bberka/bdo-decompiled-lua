...
local terrainUVForNormal = {
  ...
  [0] = {
    ...
    93,
    190,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_NORMAL")
  },
  [1] = {
    52,
    170,
    72,
    190,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_ROAD")
  },
  [2] = {
    108,
    177,
    128,
    197,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_SNOW")
  },
  [3] = {
    129,
    177,
    149,
    197,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_DESERT")
  },
  [4] = {
    150,
    177,
    170,
    197,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_SWAMP")
  },
  [5] = {
    73,
    170,
    93,
    190,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_OBJECT")
  },
  [6] = {
    171,
    177,
    191,
    197,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_WATER")
  },
  [7] = {
    73,
    170,
    93,
    190,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_GRASS")
  },
  [8] = {
    171,
    156,
    191,
    176,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_DEEPWATER")
  },
  [9] = {
    171,
    135,
    191,
    155,
    [83] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_AIR")
  }
}
...
local terrainUVForRemaster = {
  ...
  [0] = {
    ...
    21,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_NORMAL")
  },
  [1] = {
    22,
    150,
    42,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_ROAD")
  },
  [2] = {
    43,
    150,
    63,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_SNOW")
  },
  [3] = {
    64,
    150,
    84,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_DESERT")
  },
  [4] = {
    85,
    150,
    105,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_SWAMP")
  },
  [5] = {
    1,
    150,
    21,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_OBJECT")
  },
  [6] = {
    106,
    129,
    126,
    149,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_WATER")
  },
  [7] = {
    85,
    150,
    105,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_GRASS")
  },
  [8] = {
    85,
    129,
    105,
    149,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_DEEPWATER")
  },
  [9] = {
    106,
    150,
    126,
    170,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_AIR")
  },
  [10] = {
    106,
    129,
    126,
    149,
    [79] = PAGetString(Defines.StringSheet_GAME, "LUA_RADAR_TERRAININFO_OCEAN")
  }
}
...
function RadarMap_updateRegion(regionData)
  ...
  local isHideNak = isSolareInstance
...
function Radar_UpdateQuestList()
  ...
  _PA_LOG("ë…¸ëŒ€ì˜", "questCount:" .. tostring(questCount))
...
function RadarMap_HidePanelConditionCheck()
  if nil == Panel_Radar or nil == Panel_TimeBar then
    _PA_ASSERT_NAME(false, "Panel_Radar ë˜ëŠ” Panel_TimeBarì´ nil ì…ë‹ˆë‹¤.", "ì •ì§€í˜œ")
    return
  end
