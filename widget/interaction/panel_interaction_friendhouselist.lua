...
function FriendHouseRank:Update()
  ...
  _PA_LOG("ìœ í¥ì‹ ", " FriendHouseRank:Update() - UIScroll.SetButtonSize " .. self._createListCount .. " " .. self._listCount)
...
function FriendHouseRank_ScrollEvent(isScrollUp)
  ...
  _PA_LOG("ìœ í¥ì‹ ", "FriendHouseRank_ScrollEvent " .. self._startIndex)
  self:Update()
end
