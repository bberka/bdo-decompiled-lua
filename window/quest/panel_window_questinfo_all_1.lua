...
function PaGlobal_QuestInfo_All:rewardUpdate()
  ...
  if nil == self._OpenInfo or nil == self._OpenInfo._groupId or nil == self._OpenInfo._questId then
    UI.ASSERT_NAME(nil ~= self._OpenInfo, "PaGlobal_QuestInfo_All:rewardUpdate() self._OpenInfo is nil.", "ê¹€ìœ¤ì§€")
    UI.ASSERT_NAME(nil ~= self._OpenInfo._groupId, "PaGlobal_QuestInfo_All:rewardUpdate() self._OpenInfo._groupId is nil.", "ê¹€ìœ¤ì§€")
    UI.ASSERT_NAME(nil ~= self._OpenInfo._questId, "PaGlobal_QuestInfo_All:rewardUpdate() self._OpenInfo._questId is nil.", "ê¹€ìœ¤ì§€")
    return
  end
  local questInfo = questList_getQuestStatic(self._OpenInfo._groupId, self._OpenInfo._questId)
  if nil == questInfo then
    UI.ASSERT_NAME(nil ~= self._OpenInfo._questId, "PaGlobal_QuestInfo_All:rewardUpdate() questInfo is nil.", "ê¹€ìœ¤ì§€")
    return
  end
