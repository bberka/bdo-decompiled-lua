...
function PaGlobalFunc_MarketPlace_WalletInven_Open()
  ...
  PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(InvenSortLinkPanelIndex.MarketPlaceWallet, mainPanel, self._ui.btn_sortOption, self._ui.chk_sort, "Static_SortComponent_Wallet")
  PaGlobalFunc_AutoSortFunctionPanel_LoadSortOptionAndDoSort(InvenSortLinkPanelIndex.MarketPlaceWallet, false)
