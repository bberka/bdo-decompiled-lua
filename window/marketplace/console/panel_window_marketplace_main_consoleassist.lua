...
function PaGlobalFunc_MarketPlace_ItemMarket_ViewDetailToolTip(isShow)
  ...
  elseif base._itemListType.waitListByCategory == self._currentListType then
    ...
    _PA_ASSERT(false, "ì¸ë±ìŠ¤ê°€ ì˜¬ë°”ë¥´ì§€ ì•ŠìŠµë‹ˆë‹¤. : PaGlobalFunc_MarketPlace_ItemMarket_ViewDetailToolTip()")
  end
  if nil == itemInfo then
    _PA_ASSERT(false, "ì •ë³´ê°€ ì˜¬ë°”ë¥´ì§€ ì•ŠìŠµë‹ˆë‹¤!! : PaGlobalFunc_MarketPlace_ItemMarket_ViewDetailToolTip()")
    return
  end
  local itemSSW
  if base._itemListType.categoryList == self._currentListType then
