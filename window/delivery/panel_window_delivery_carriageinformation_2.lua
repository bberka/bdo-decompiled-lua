function HandleEventMO_DeliveryCarriageInformation_ShowItemTooltip(idx, isOn)
  UI.ASSERT_NAME(nil ~= idx, "HandleEventMO_DeliveryCarriageInformation_ShowItemTooltip idxê°€ nil", "ê¹€ì˜ì§„")
  UI.ASSERT_NAME(nil ~= isOn, "HandleEventMO_DeliveryCarriageInformation_ShowItemTooltip isOnê°€ nil", "ê¹€ì˜ì§„")
...
function HandleEventScroll_DeliveryCarriageInformation_UpdateSlot(isScrollUp)
  UI.ASSERT_NAME(nil ~= isScrollUp, "HandleEventScroll_DeliveryCarriageInformation_UpdateSlot isScrollUp nil", "ê¹€ì˜ì§„")
