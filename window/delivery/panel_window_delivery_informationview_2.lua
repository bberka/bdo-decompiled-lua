...
function HandleEventMO_DeliveryInformationView_TooltipShow(idx, isOn)
  UI.ASSERT_NAME(nil ~= idx, "HandleEventMO_DeliveryInformationView_TooltipShow idx nil", "ê¹€ì˜ì§„")
  UI.ASSERT_NAME(nil ~= isOn, "HandleEventMO_DeliveryInformationView_TooltipShow isOn nil", "ê¹€ì˜ì§„")
  if nil == Panel_Window_Delivery_InformationView then
    return
  end
  if false == isOn then
