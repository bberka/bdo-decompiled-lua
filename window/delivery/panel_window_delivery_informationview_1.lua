...
function PaGlobal_InformationView:registEventHandler()
  ...
  if true == isGameTypeKR2() then
    PaGlobal_InformationView._ui._buttonQuestion:SetShow(false)
  end
end
...
function DeliveryView_ListControlCreate_New(content, key)
  UI.ASSERT_NAME(nil ~= content, "DeliveryView_ListControlCreate content nil", "ì´ìˆ˜ì¢…")
  UI.ASSERT_NAME(nil ~= key, "DeliveryView_ListControlCreate key nil", "ì´ìˆ˜ì¢…")
  if nil == Panel_Window_Delivery_InformationView then
    return
  end
