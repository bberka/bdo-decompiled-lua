...
function HandleEventMO_DeliveryInformation_ShowDeliveryTime(idx, isOn)
  UI.ASSERT_NAME(nil ~= idx, "HandleEventMO_DeliveryInformation_ShowDeliveryTime idx nil", "ê¹€ì˜ì§„")
  UI.ASSERT_NAME(nil ~= isOn, "HandleEventMO_DeliveryInformation_ShowDeliveryTime isOn nil", "ê¹€ì˜ì§„")
  if false == isOn then
    TooltipSimple_Hide()
    return
  end
...
function PaGlobalFunc_DeliveryInformation_Receive(delivererIndex, itemIndex)
  UI.ASSERT_NAME(nil ~= delivererIndex, "PaGlobalFunc_DeliveryInformation_Receive delivererIndex nil", "ì´ìˆ˜ì¢…")
  UI.ASSERT_NAME(nil ~= itemIndex, "PaGlobalFunc_DeliveryInformation_Receive itemIndex nil", "ì´ìˆ˜ì¢…")
...
function PaGlobalFunc_DeliveryInformation_Cancel(delivererIndex, itemIndex)
  UI.ASSERT_NAME(nil ~= delivererIndex, "PaGlobalFunc_DeliveryInformation_Cancel delivererIndex nil", "ì´ìˆ˜ì¢…")
  UI.ASSERT_NAME(nil ~= itemIndex, "PaGlobalFunc_DeliveryInformation_Cancel itemIndex nil", "ì´ìˆ˜ì¢…")
  local delivererInfo = ToClient_NewDeliveryGetDeliverer(delivererIndex)
  if nil == delivererInfo then
    return
  end
...
function HandleEventMO_DeliveryInformation_ItemTooltipShow(delivererIndex, itemIndex, isOn)
  UI.ASSERT_NAME(nil ~= delivererIndex, "HandleEventMO_DeliveryInformation_ItemTooltipShow delivererIndex nil", "ì´ìˆ˜ì¢…")
  UI.ASSERT_NAME(nil ~= itemIndex, "HandleEventMO_DeliveryInformation_ItemTooltipShow itemIndex nil", "ì´ìˆ˜ì¢…")
  UI.ASSERT_NAME(nil ~= isOn, "HandleEventMO_DeliveryInformation_ItemTooltipShow isOn nil", "ì´ìˆ˜ì¢…")
  if false == isOn then
