...
function DeliveryRequest_PushPackingItem(warehouseSlotNo, s64_count)
  UI.ASSERT_NAME(nil ~= warehouseSlotNo, "DeliveryRequest_PushPackingItem warehouseSlotNo nil", "ì´ìˆ˜ì¢…")
  UI.ASSERT_NAME(nil ~= s64_count, "DeliveryRequest_PushPackingItem s64_count nil", "ì´ìˆ˜ì¢…")
  if nil == Panel_Window_Delivery_Request then
    return
  end
