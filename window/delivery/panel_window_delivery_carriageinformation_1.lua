...
function PaGlobal_CarriageInformation:prepareOpen(objectID)
  UI.ASSERT_NAME(nil ~= objectID, "PaGlobal_CarriageInformation:prepareOpen objectID nil", "ê¹€ì˜ì§„")
  if nil == Panel_Window_Delivery_CarriageInformation then
    return
  end
...
function DeliveryCarriageInformation_SlotIndex(slotNo)
  ...
  UI.ASSERT_NAME(nil ~= slotNo, "DeliveryCarriageInformation_SlotIndex slotNo nil", "ê¹€ì˜ì§„")
