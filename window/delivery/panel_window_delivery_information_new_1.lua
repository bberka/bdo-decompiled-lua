...
function Delivery_ListControlCreate(content, key)
  UI.ASSERT_NAME(nil ~= content, "Delivery_ListControlCreate content nil", "ì´ìˆ˜ì¢…")
  UI.ASSERT_NAME(nil ~= key, "Delivery_ListControlCreate key nil", "ì´ìˆ˜ì¢…")
...
function DeliveryInformation_OpenPanelFromWorldmap(waypointKey)
  ...
  UI.ASSERT_NAME(nil ~= waypointKey, "DeliveryInformation_OpenPanelFromWorldmap waypointKey nil", "ê¹€ì˜ì§„")
...
function DeliveryInformation_SlotIndex(slotNo)
  UI.ASSERT_NAME(nil ~= slotNo, "DeliveryInformation_SlotIndex slotNo nil", "ê¹€ì˜ì§„")
  return slotNo
end
