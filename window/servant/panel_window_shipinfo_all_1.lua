...
function PaGlobal_ShipInfo_All:updateShipStat()
  ...
  if true == isUseExtraStat then
    if 0 == extraSpeed then
      self._ui.txt_basic_Speed:SetText(string.format("%.1f", speed * 0,0001) .. "%(+0%)")
    else
      self._ui.txt_basic_Speed:SetText(string.format("%.1f", speed * 0,0001) .. "%" .. "(+" .. string.format("%.1f", extraSpeed * 0,0001) .. "%)")
    end
    if 0 == extraAccel then
      self._ui.txt_basic_Accel:SetText(string.format("%.1f", accel * 0,0001) .. "%(+0%)")
    else
      self._ui.txt_basic_Accel:SetText(string.format("%.1f", accel * 0,0001) .. "%" .. "(+" .. string.format("%.1f", extraAccel * 0,0001) .. "%)")
    end
    if 0 == extraCornering then
      self._ui.txt_basic_Cornering:SetText(string.format("%.1f", cornering * 0,0001) .. "%(+0%)")
    else
      self._ui.txt_basic_Cornering:SetText(string.format("%.1f", cornering * 0,0001) .. "%" .. "(+" .. string.format("%.1f", extraCornering * 0,0001) .. "%)")
    end
    if 0 == extraBraking then
      self._ui.txt_basic_Break:SetText(string.format("%.1f", braking * 0,0001) .. "%(+0%)")
    else
      self._ui.txt_basic_Break:SetText(string.format("%.1f", braking * 0,0001) .. "%" .. "(+" .. string.format("%.1f", extraBraking * 0,0001) .. "%)")
    end
  else
    self._ui.txt_basic_Speed:SetText(string.format("%.1f", speed * 0,0001) .. "%")
    self._ui.txt_basic_Accel:SetText(string.format("%.1f", accel * 0,0001) .. "%")
    self._ui.txt_basic_Cornering:SetText(string.format("%.1f", cornering * 0,0001) .. "%")
    self._ui.txt_basic_Break:SetText(string.format("%.1f", braking * 0,0001) .. "%")
  end
  ...
  self._ui.txt_basic_ResistCurrent:SetText(string.format("%.1f", vehicleActorWrapper:getEmployeeStats(__eEmployeeAbility_Resist_OceanCurrent) * 0,0001) .. "%")
  self._ui.txt_baisc_ResistWind:SetText(string.format("%.1f", vehicleActorWrapper:getEmployeeStats(__eEmployeeAbility_Resist_WindDirection) * 0,0001) .. "%")
  self._ui.stc_basic_ResistFood:SetText(string.format("%.1f", vehicleActorWrapper:getEmployeeStats(__eEmployeeAbility_Resist_Food) * 0,0001) .. "%")
  self._ui.stc_basic_ResistRoyal:SetText(string.format("%.1f", vehicleActorWrapper:getEmployeeStats(__eEmployeeAbility_Resist_Loyalty) * 0,0001) .. "%")
end
function PaGlobal_ShipInfo_All:updateCannonStat()
  ...
  self._ui.txt_basic_CannonMaxAngle:SetText(string.format("%.1f", ToClient_GetManualCannonFireCannonStatus(__eServantStatTypeCannonMaxAngle)) .. "Ëš")
end
