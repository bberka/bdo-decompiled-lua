...
function PaGlobal_VehicleInfo_All:updateStat()
  ...
  self._ui._txt_speedValue:SetText(string.format("%.1f", servantWrapper:getStat(CppEnums.ServantStatType.Type_MaxMoveSpeed) * 0,0001) .. "%")
  self._ui._txt_accelerationValue:SetText(string.format("%.1f", servantWrapper:getStat(CppEnums.ServantStatType.Type_Acceleration) * 0,0001) .. "%")
  self._ui._txt_corneringValue:SetText(string.format("%.1f", servantWrapper:getStat(CppEnums.ServantStatType.Type_CorneringSpeed) * 0,0001) .. "%")
  self._ui._txt_brakeValue:SetText(string.format("%.1f", servantWrapper:getStat(CppEnums.ServantStatType.Type_BrakeSpeed) * 0,0001) .. "%")
end
