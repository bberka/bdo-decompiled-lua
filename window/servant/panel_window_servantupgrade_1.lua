...
function PaGlobal_ServantUpgrade:open(servantNo_s64, fromCharacterKey, servantName, isTree)
...
function PaGlobal_ServantUpgrade:selectToServant(toCharacterKey)
  ...
  self._ui._btn_shipTree:SetSpanSize(230, 10)
  if false == self._isUpgradable then
  ...
  if true == self._isTree then
    ...
    self._ui._btn_shipTree:SetSpanSize(0, 10)
  end
  if true == self._isConsole then
    self._ui._btn_doUpgrade:SetShow(false)
  end
...
function HandleEventLUp_ServantUpgrade_handleClickedViewTree(key)
  ...
  PaGlobal_ServantUpgrade_Tree:open(self._fromCharacterKey, self._toCharacterKey)
end
