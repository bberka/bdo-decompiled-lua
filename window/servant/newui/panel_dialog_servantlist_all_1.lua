...
function PaGlobal_ServantList_All:prepareOpen()
  ...
  if waypointKey ~= nil and currentNPCType == self._ENUM_NPC_TYPE._LAND then
    if PaGlobal_EasyBuy:checkExistCashItem(15, waypointKey) == true then
      self._ui._btn_BuyWeight:SetShow(true)
    else
      self._ui._btn_BuyWeight:SetShow(false)
    end
