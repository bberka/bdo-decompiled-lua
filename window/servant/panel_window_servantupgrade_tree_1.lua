...
function PaGlobal_ServantUpgrade_Tree:OpenUpgrade(key, index)
  ...
  PaGlobal_ServantUpgrade:open(nil, key, "", true)
  if 1 == index then
    PaGlobal_ServantUpgrade_SelectedIndex(1)
  elseif 2 == index then
    PaGlobal_ServantUpgrade_SelectedIndex(0)
  elseif 3 == index then
    PaGlobal_ServantUpgrade_SelectedIndex(0)
  elseif 4 == index then
    PaGlobal_ServantUpgrade_SelectedIndex(0)
...
function PaGlobal_ServantUpgrade_Tree:open(shipKey, upgradeKey)
  if nil == shipKey then
    return
  end
