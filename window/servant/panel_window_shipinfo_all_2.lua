...
function HandleEventLUp_ShipInfoAll_SelectSailor(index)
  ...
  control.txt_sailor_speed:SetText(string.format("%.1f", sailorInfo._speed * 0,0001) .. "%")
  control.txt_sailor_turning:SetText(string.format("%.1f", sailorInfo._turning * 0,0001) .. "%")
  control.txt_sailor_feed:SetText(sailorInfo._foodConsume)
  control.txt_sailor_accel:SetText(string.format("%.1f", sailorInfo._accel * 0,0001) .. "%")
  control.txt_sailor_break:SetText(string.format("%.1f", sailorInfo._break * 0,0001) .. "%")
  control.txt_sailor_cost:SetText(sailorInfo._cost)
  control.txt_sailor_cannonCoolTimeValue:SetText(string.format("%.1f", sailorInfo._cannonCoolTime * 0,0001) .. "%")
  control.txt_sailor_cannonAccuracyValue:SetText(string.format("%.1f", sailorInfo._cannonAccuracy * 0,0001) .. "%")
  control.txt_sailor_cannonMaxLengthValue:SetText(string.format("%.1f", sailorInfo._cannonMaxLength * 0,0001) .. "%")
  control.txt_sailor_cannonMaxAngleValue:SetText(string.format("%.1f", sailorInfo._cannonMaxAngle * 0,0001) .. "%")
