...
function FromClient_LDownWorldMapPanel()
  if isKeyPressed(VCK.KeyCode_CONTROL) then
    ...
    ToClient_requestWordmapPin(true, false, false, ToClient_GetPingType())
  elseif isKeyPressed(VCK.KeyCode_SHIFT) then
    ...
    ToClient_requestWordmapPin(false, false, false, __eNotifyPingTypeBDO_None)
  elseif isKeyPressed(VCK.KeyCode_SPACE) then
    ToClient_requestWordmapPin(true, false, true, ToClient_GetPingType())
  end
end
function FromClient_LDoubleClickWorldMapPanel()
  if isKeyPressed(VCK.KeyCode_CONTROL) then
    ...
    ToClient_requestWordmapPin(true, true, false, ToClient_GetPingType())
  elseif isKeyPressed(VCK.KeyCode_SHIFT) then
    local selfPlayerWrapper = getSelfPlayer()
    if nil == selfPlayerWrapper then
      return
    ...
    ToClient_requestWordmapPin(false, true, false, __eNotifyPingTypeBDO_None)
  elseif isKeyPressed(VCK.KeyCode_SPACE) then
    ToClient_requestWordmapPin(true, true, true, ToClient_GetPingType())
  end
end
