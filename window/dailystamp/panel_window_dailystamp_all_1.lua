...
function PaGlobal_DailyStamp_All:acceptRewardAll(tabIndex)
  if nil == tabIndex then
    UI.ASSERT_NAME(nil ~= tabIndex, "PaGlobal_DailyStamp_All:acceptRewardAll tabIndex nil", "ì •ì§€í˜œ")
    return
  end
...
function PaGlobal_DailyStamp_All:setData(tabIndex)
  ...
  if nil == tabIndex then
    UI.ASSERT_NAME(nil ~= tabIndex, "PaGlobal_DailyStamp_All:setData tabIndex nil", "ì •ì§€í˜œ")
    return
  end
  ...
  if true == _ContentsGroup_TransferEventBuff then
    ...
    if 3 == userConnectionType and false == isTransferAccount then
      ...
      local messageBoxData = {
        ...
        functionYes = PaGlobal_SA_Common_TransferLink,
...
function PaGlobalFunc_DailyStamp_All_SetAnimation(tabIndex, dayIndex)
  ...
  if nil == tabIndex or nil == dayIndex then
    UI.ASSERT_NAME(nil ~= tabIndex, "PaGlobalFunc_DailyStamp_All_SetAnimation tabIndex nil", "ì •ì§€í˜œ")
    UI.ASSERT_NAME(nil ~= dayIndex, "PaGlobalFunc_DailyStamp_All_SetAnimation dayIndex nil", "ì •ì§€í˜œ")
    return
  end
...
function PaGlobalFunc_DailyStamp_All_ChangeTexture(index, recieveType, itemGradeType)
  UI.ASSERT_NAME(nil ~= index, "PaGlobalFunc_DailyStamp_All_ChangeTexture index nil", "ì •ì§€í˜œ")
  UI.ASSERT_NAME(nil ~= recieveType, "PaGlobalFunc_DailyStamp_All_ChangeTexture recieveType nil", "ì •ì§€í˜œ")
  UI.ASSERT_NAME(nil ~= itemGradeType, "PaGlobalFunc_DailyStamp_All_ChangeTexture itemGradeType nil", "ì •ì§€í˜œ")
  if nil == Panel_Window_DailyStamp_All then
    return
  end
