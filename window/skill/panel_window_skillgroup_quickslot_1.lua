...
function PaGlobal_SkillGroup_QuickSlot:createQuickSlot(cloneControl, parent)
  UI.ASSERT(nil ~= cloneControl, "PaGlobal_SkillGroup_QuickSlot:createQuickSlot() cloneControl ì´ ì—†ìŠµë‹ˆë‹¤.")
  UI.ASSERT(nil ~= parent, "PaGlobal_SkillGroup_QuickSlot:createQuickSlot() parent ì´ ì—†ìŠµë‹ˆë‹¤.")
