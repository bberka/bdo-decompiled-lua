...
function PaGlobal_SkillGroup:open()
  ...
  if PaGlobal_Widget_HadumField_Enter_All_CheckHadumFieldEnterAction ~= nil and PaGlobal_Widget_HadumField_Enter_All_CheckHadumFieldEnterAction() == true then
  ...
  if __eClassType_Sage == classType or __eClassType_Corsair == classType or __eClassType_Drakania == classType then
...
function PaGlobal_SkillGroup:GetBottomPosY(control)
  UI.ASSERT(nil ~= control, "PaGlobal_SkillGroup:GetBottomPosY() control ì´ ì—†ìŠµë‹ˆë‹¤.")
  ...
  if __eSkillGroupCellType_SkillGroup == cellType then
    ...
    if cellType >= __eSkillGroupCellType_LT and cellType <= __eSkillGroupCellType_Vert then
      ...
      for ii = 0, cellTypeSize - 1 do
        ...
        UI.ASSERT(nil ~= control, "PaGlobal_SkillGroup:createCell() LineControl ì´ ì—†ìŠµë‹ˆë‹¤.")
...
function PaGlobal_SkillGroup:learnSkill(skillNo)
  UI.ASSERT(nil ~= skillNo, "PaGlobal_SkillGroup:learnSkill - skillNoê°€ ì—†ìŠµë‹ˆë‹¤.")
  if false == Panel_Window_SkillGroup:GetShow() then
    return
  end
  local selfPlayerWrapper = getSelfPlayer()
...
function PaGlobal_SkillGroup:ShowGroupLearnLastSkillByGroupKey(skillGroupKey, isLearnSkill)
  UI.ASSERT(nil ~= self._skillGroupList, "PaGlobal_SkillGroup:ShowGroupLearnLastSkillByGroupKey() self._skillGroupListê°€ ì—†ìŠµë‹ˆë‹¤.")
...
function PaGlobal_SkillGroup:ShowGroupLearnLastSkillByGroup(skillGroup, isLearnSkill)
  if nil ~= skillGroup then
    ...
    UI.ASSERT(nil ~= skillGroup, "PaGlobal_SkillGroup:ShowGroupLearnLastSkillByGroup() skillGroupì´ nilì…ë‹ˆë‹¤.")
  end
end
...
function PaGlobal_SkillGroup:createDeepeningSkillSlot(skillSlotArea, skillSlotBg, skillNo, slotNo, index)
  UI.ASSERT(nil ~= skillSlotBg, "PaGlobal_SkillGroup:createDeepeningSkillSlot() skillSlotBg ì´ ì—†ìŠµë‹ˆë‹¤.")
  UI.ASSERT(nil ~= skillNo, "PaGlobal_SkillGroup:createDeepeningSkillSlot() skillNoê°€ ì—†ìŠµë‹ˆë‹¤.")
  local slot = {}
...
function PaGlobal_SkillGroup:UpdateSkillMonoTone(slot, skillNo, isFusionAndLearnNeedAll)
  UI.ASSERT(nil ~= slot, "PaGlobal_SkillGroup:UpdateSkillMonoTone() slotì´ ì—†ìŠµë‹ˆë‹¤.")
  UI.ASSERT(nil ~= skillNo, "PaGlobal_SkillGroup:UpdateSkillMonoTone() skillNoê°€ ì—†ìŠµë‹ˆë‹¤.")
  local skillLevelInfo = getSkillLevelInfo(skillNo)
  if nil == skillLevelInfo then
    return false
  end
...
function PaGlobal_SkillGroup:createDeepeningControl(control)
  ...
  for slotNo = 0, self._maxDeepeningSkillCount - 1 do
    UI.ASSERT(nil ~= control, "PaGlobal_SkillGroup:createDeepeningControl control ì´ ì—†ìŠµë‹ˆë‹¤.")
...
function PaGlobal_SkillGroup:ShowSkillGroupDeepengingSkillCCTooltip(index, isShow, slotNo, jj)
  ...
  elseif index == 17 then
    ...
    UI.ASSERT(false, "SkillCCType ì•„ì´ì½˜ì´ ì¶”ê°€ë  ê²½ìš° íˆ´íŒ ìŠ¤íŠ¸ë§ ì¶”ê°€ë„ í•„ìš”í•©ë‹ˆë‹¤.")
  end
  if true == isShow then
...
function PaGlobal_SkillGroup:GetConvertTabIndex(skillType)
  UI.ASSERT(nil ~= skillType, "PaGlobal_SkillGroup:GetConvertTabIndex() skillType ì´ ì—†ìŠµë‹ˆë‹¤.")
...
function PaGlobal_SkillGroup:HandleMOver_SkillGroupOn(key)
  ...
  local skillGroup = self._skillGroupList[key]
  UI.ASSERT_NAME(nil ~= skillGroup, "PaGlobal_SkillGroup:HandleMOver_SkillGroupOn skillGroup nil", "ê¹€ì§€í˜")
...
function PaGlobal_SkillGroup:HandleMOver_SkillGroupOut(key)
  local skillGroup = self._skillGroupList[key]
  UI.ASSERT_NAME(nil ~= skillGroup, "PaGlobal_SkillGroup:HandleMOver_SkillGroupOut skillGroup nil", "ê¹€ì§€í˜")
