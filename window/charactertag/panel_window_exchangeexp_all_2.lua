...
function HandleEventLUp_ExchangeExp_All_ChangeConfirm()
  ...
  local selfCharacterData = getCharacterDataByIndex(selfCharacterIndex)
  local selfCharacterName = getCharacterName(selfCharacterData)
  local characterData = getCharacterDataByIndex(PaGlobal_ExchangeExp_All._selectedCharacterIndex)
