...
function PaGlobal_TranslationReport:Open(staticType, key1, key2, key3, textNo)
  ...
  url = url .. "/Translation" .. "" .. tostring(userNo) .. "&certKey=" .. tostring(cryptKey) .. "&translationKey1=" .. tostring(key1) .. "&translationKey2=" .. tostring(key2) .. "&translationKey3=" .. tostring(key3) .. "&textNo=" .. tostring(textNo) .. "&serviceResourceType=" .. tostring(serviceResourceType) .. "&staticType=" .. tostring(staticType)
