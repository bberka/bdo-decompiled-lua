...
function PaGlobal_BlackDesertLab_Show()
  ...
  self._url = tostring(ToClient_getGTAccountURL()) .. "/GlobalLabRegister" .. tostring(ToClient_isCompleteTesterSubmit())
  _PA_LOG("í—ˆì¬ì„", "PaGlobal_BlackDesertLab URL : " .. tostring(self._url))
