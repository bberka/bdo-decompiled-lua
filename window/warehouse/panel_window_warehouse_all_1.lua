function PaGlobal_WareHouse_All:initialize()
  ...
  PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(InvenSortLinkPanelIndex.WareHouse, Panel_Window_Warehouse, self._ui._btn_sortOption, self._ui._chk_itemSort)
...
function PaGlobal_WareHouse_All:registEventHandler()
  ...
  if true == isGameTypeKR2() then
    self._ui._pc._btn_question:SetShow(false)
  end
...
function PaGlobal_WareHouse_All:resizePanelChange(isNpc)
  ...
  if not self:isGuildHouse() and not self:isGuildItemShare() then
    ...
    self._ui._stc_rightBottomBg:SetSize(self._defaultRightBgSize.x, self._defaultRightBgSize.y)
...
function PaGlobal_WareHouse_All:openPanel(waypointKey, fromType)
  ...
  if (CppEnums.WarehoouseFromType.eWarehoouseFromType_Npc == self._fromType or CppEnums.WarehoouseFromType.eWarehoouseFromType_Manufacture == self._fromType) and ToClient_isPossibleManufactureAtWareHouse() == true then
