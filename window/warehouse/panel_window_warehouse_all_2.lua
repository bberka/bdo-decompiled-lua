...
function HandleEventLUp_Warehouse_All_LDownClick(index)
  ...
  if true == isGameTypeKR2() and 0 == PaGlobal_WareHouse_All.savedWayPointKey and CppEnums.WarehoouseFromType.eWarehoouseFromType_Npc == PaGlobal_WareHouse_All._fromType then
