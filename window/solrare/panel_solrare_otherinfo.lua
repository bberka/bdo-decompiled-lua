...
function PaGlobal_Solrare_OtherInfo:updateByRanking(index, topIndex)
  ...
  PaGlobalFunc_Solrare_Ranking_SetClassBigBg(self._ui._stc_ClassIcon, classType)
  ...
  if classType == __eClassType_ShyWaman or classType == __eClassType_RangerMan then
    self._ui._stc_Awaken:SetShow(false)
    self._ui._stc_Succesion:SetShow(false)
    branchName = ""
  end
...
function PaGlobal_Solrare_OtherInfo:updateByClassRanking(index, rankClassType, topIndex)
  ...
  PaGlobalFunc_Solrare_Ranking_SetTierIconByScore(self._ui._stc_RankIcon, recordInfo:getRankRating())
  PaGlobalFunc_Solrare_Ranking_SetClassBigBg(self._ui._stc_ClassIcon, topIndexClassType)
  self._ui._txt_Score:SetText(tostring(recordInfo:getRankRating()))
  self._ui._txt_Name:SetText(tostring(recordInfo:getName()))
  self._ui._stc_Awaken:SetShow(false)
  self._ui._stc_Succesion:SetShow(false)
  local branch = recordInfo:getSkillBranch(topIndex)
  local branchName = ""
  if (__eClassType_Sage == topIndexClassType or __eClassType_Corsair == topIndexClassType or __eClassType_Drakania == topIndexClassType) and branch == __eSkillTypeParam_Normal then
  ...
  if topIndexClassType == __eClassType_ShyWaman or topIndexClassType == __eClassType_RangerMan then
    branchName = ""
    self._ui._stc_Awaken:SetShow(false)
    self._ui._stc_Succesion:SetShow(false)
  end
...
function PaGlobal_Solrare_OtherInfo:updateByRecord(index)
  ...
  self._ui._txt_Name:SetText(tostring(recordInfo:getName()))
  if recordInfo:getMode() == __eSolareMode_Normal then
  ...
  local branchName = ""
  if (__eClassType_Sage == classType or __eClassType_Corsair == classType or __eClassType_Drakania == classType) and branch == __eSkillTypeParam_Normal then
    branch = __eSkillTypeParam_Inherit
  end
  if branch == __eSkillTypeParam_Normal then
    self._ui._stc_Succesion:SetShow(true)
...
function PaGlobalFunc_Solrare_OtherInfo_ShowRecentRecordItemTooltip(isMain, equipSlotIndex, index, equipSlotNo)
  ...
  Panel_Tooltip_Item_Show(itemWrapper, slot, false, true)
end
