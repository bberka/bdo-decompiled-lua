  ...
  for index = 1, recoveryItemSize do
    ...
    if nil ~= recoveryItem then
      ...
      if nil == restoreSlot then
        _PA_SVC_LOG("ìŠ¬ë¡¯ì´ ì—†ìŠµë‹ˆë‹¤. ì„ ì› ì „ì²´ ì¶©ì„±ë„ íšŒë³µ UIì •ìƒë™ì‘ í•˜ì§€ ì•ŠìŠµë‹ˆë‹¤.")
        return
      end
      ...
      if nil == itemStatic then
        _PA_SVC_LOG("itemStatic ì •ë³´ê°€ ì—†ìŠµë‹ˆë‹¤. ì„ ì› ì „ì²´ ì¶©ì„±ë„ íšŒë³µ UIì •ìƒë™ì‘ í•˜ì§€ ì•ŠìŠµë‹ˆë‹¤.")
        return
      end
