...
function PaGlobalFunc_SailorOnBoardAll_AddStatforShip(sailorInfo)
  ...
  if nil ~= PaGlobal_SailorOnBoard_All._unsealServantInfo then
    ...
    local statString = {
      ...
      _cannonMaxAngle = {
        origin = string.format("%.1f", cannonMaxAngle) .. "Ëš",
