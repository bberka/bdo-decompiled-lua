...
function PaGlobal_SailorManager_All:getAddItionalStatString(isApply, value)
  ...
  if false == isApply then
    return "<PAColor0xFFFFCE22>â–²" .. string.format("%.1f", value * 0,0001) .. "<PAOldColor>"
  else
    return "<PAColor0xFFFF0000>â–¼" .. string.format("%.1f", value * 0,0001) .. "<PAOldColor>"
  end
end
function PaGlobal_SailorManager_All:getAddItionalStatStringRaw(isApply, value)
  ...
  if false == isApply then
    return "<PAColor0xFFFFCE22>â–²" .. string.format("%.1f", value) .. "<PAOldColor>"
  else
    return "<PAColor0xFFFF0000>â–¼" .. string.format("%.1f", value) .. "<PAOldColor>"
  end
end
