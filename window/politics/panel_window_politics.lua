...
function PaGlobal_Window_Politics:initialize()
  ...
  self._ui.btn_sortByDate:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_POLITICS_SORT_REGIST") .. " â–¼")
  ...
  self._ui.btn_sortByVote:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_POLITICS_SORT_VOTE") .. " â–¼")
...
function FGlobal_Window_Politics_CandidateListControlCreate(control, key)
  ...
  _PA_LOG("ë°•ë²”ì¤€", "candidateInfo.userCharacterNo : " .. tostring(candidateInfo.userCharacterNo))
