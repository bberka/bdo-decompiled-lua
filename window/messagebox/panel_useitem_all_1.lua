...
function PaGlobal_UseItem_All:registEventHandler()
  ...
  if false == self._isConsole then
    ...
    registerEvent("FromClient_ItemLocalUpdated", "FromClient_UseItem_All_PopupItemDescDefferedOpen()")
  end
end
...
function PaGlobal_UseItem_All:deferredPopupItemShowRequest(itemEnchatWrapper, whereType, slotNo, equipSlotNo)
  ...
  if "" == itemEnchatWrapper:getPopupItemDesc() then
    ...
    itemEnchatWrapper:updateLocalDataAll()
    return
  end
  self:prepareOpen()
  self:resetUIcontrol()
