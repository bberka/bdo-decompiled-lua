function PaGlobal_QuickTimeEvent_CircleKeyDown:initialize()
  ...
  if self._MANAGER == nil then
    _PA_ASSERT(false, "í€µ íƒ€ì„ ì´ë²¤íŠ¸ ë§¤ë‹ˆì €ê°€ ì—†ìŠµë‹ˆë‹¤. Initialize ìˆœì„œê°€ ë°”ë€Œì§€ ì•Šì•˜ëŠ”ì§€ í™•ì¸ ë°”ëë‹ˆë‹¤.")
    return
  end
...
function PaGlobal_QuickTimeEvent_CircleKeyDown:prepareOpen()
  ...
  if self._MANAGER == nil then
    _PA_ASSERT(false, "í€µ íƒ€ì„ ì´ë²¤íŠ¸ ë§¤ë‹ˆì €ê°€ ì—†ìŠµë‹ˆë‹¤. í™•ì¸ í•„ìš”!")
    return
  end
