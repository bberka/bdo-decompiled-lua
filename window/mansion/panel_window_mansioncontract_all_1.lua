function PaGlobal_MansionContract:initialize()
  ...
  PaGlobal_MansionContract.ui._stc_keyGuideBG = UI.getChildControl(Panel_Window_Mansion_Contract_All, "Static_KeyGuide_ConsoleUI")
  PaGlobal_MansionContract.ui._stc_keyGuideBG:SetShow(self._isConsole)
