...
function HandleEventOn_Extraction_System_All_ShowToolTip(key, isShow)
  UI.ASSERT_NAME(nil ~= key, "HandleEventOn_Extraction_System_All_ShowToolTipì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventOn_Extraction_System_All_ShowListToolTip(isEquip, idx, isShow)
  UI.ASSERT_NAME(nil ~= isEquip, "HandleEventOn_Extraction_System_All_ShowListToolTipì˜ isEquip nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= idx, "HandleEventOn_Extraction_System_All_ShowListToolTipì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == Panel_Window_Extraction_System_All then
    return
  end
  local itemWrapper
...
function HandleEventLUp_Extraction_System_All_SystemItem(key)
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_System_All_SystemItemì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  for index = 1, PaGlobal_Extraction_System_All._systemCnt do
    PaGlobal_Extraction_System_All._itemInfo.isExtractionEquip[index] = false
  end
  local slotNo = PaGlobal_Extraction_System_All._itemInfo.slotNo[key]
...
function HandleEventLUp_Extraction_System_All_equipmentItem(equipNo)
  UI.ASSERT_NAME(nil ~= equipNo, "HandleEventLUp_Extraction_System_All_equipmentItemì˜ equipNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_System_All_ListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Extraction_System_All_ListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_System_All_ListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
