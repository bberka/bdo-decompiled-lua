...
function PaGlobal_Extraction_Blackstone_All:filterBlackStoneItem(slotNo, itemWrapper, whereType, isEquip)
  ...
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Extraction_Blackstone_All:filterBlackStoneItemì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function PaGlobal_Extraction_Blackstone_All:setExtractionIcon(slotNo, itemWrapper)
  ...
  self._thisIsWeapone = itemEnchantStaticStatus:isSubWeapon() or itemEnchantStaticStatus:isWeapon() or itemEnchantStaticStatus:isAwakenWeapon()
