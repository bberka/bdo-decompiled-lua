...
function HandleEventOn_Extraction_Costume_All_ShowToolTip(isEquip, idx, whereType, isShow, key)
  UI.ASSERT_NAME(nil ~= isEquip, "HandleEventOn_Extraction_Costume_All_ShowToolTip isEquip nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= idx, "HandleEventOn_Extraction_Costume_All_ShowToolTip idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Costume_All_ListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Extraction_Costume_All_ListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_Costume_All_ListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Costume_All_CostumeItem(key, isForce)
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_Costume_All_CostumeItemì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Costume_All_EquipmentItem(equipNo)
  UI.ASSERT_NAME(nil ~= equipNo, "HandleEventLUp_Extraction_Costume_All_equipmentItemì˜ equipNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
