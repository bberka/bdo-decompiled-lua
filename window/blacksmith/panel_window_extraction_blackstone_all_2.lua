...
function HandleEventLUp_Extraction_Blackstone_All_equipmentItem(equipNo)
  UI.ASSERT_NAME(nil ~= equipNo, "HandleEventLUp_Extraction_Blackstone_All_equipmentItemì˜ equipNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Blackstone_All_BlackstoneItem(key)
  UI.ASSERT_NAME(nil ~= key, "andleEventLUp_Extraction_Blackstone_All_BlackstoneItemì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Blackstone_All_ListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Extraction_Caphras_All_ListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_Caphras_All_ListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
