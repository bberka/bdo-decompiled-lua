...
function PaGlobal_Endurance_Recovery_All:setRecoveryListInfo(isEquip, value, itemWrapper)
  UI.ASSERT_NAME(nil ~= value, "PaGlobal_Endurance_Recovery_All:setRecoveryListInfoì˜ value nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function PaGlobal_Endurance_Recovery_All:filterMaterialItem(slotNo, whereType, itemWrapper)
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Endurance_Recovery_All:filterMaterialItemì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= whereType, "PaGlobal_Endurance_Recovery_All:filterMaterialItemì˜ whereType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == itemWrapper then
    return true
  end
...
function PaGlobal_Endurance_Recovery_All:setMaterialListInfo(slotNo, whereType, itemSSW)
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Endurance_Recovery_All:setMaterialListInfoì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= whereType, "PaGlobal_Endurance_Recovery_All:setMaterialListInfoì˜ whereType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == itemSSW then
    return
  end
...
function PaGlobal_Endurance_Recovery_All:setRecoveryIcon(itemWrapper, slotNo)
  UI.ASSERT_NAME(nil ~= itemWrapper, "PaGlobal_Endurance_Recovery_All:setRecoveryIconì˜ itemWrapper nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Endurance_Recovery_All:setRecoveryIconì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == Panel_Window_Endurance_Recovery_All then
    return
  end
