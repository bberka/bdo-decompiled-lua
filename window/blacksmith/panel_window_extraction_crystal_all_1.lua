...
function PaGlobal_Extraction_Crystal_All:setExtractionListInfo(isEquip, num, itemSSW)
  UI.ASSERT_NAME(nil ~= isEquip, "PaGlobal_Extraction_Crystal_All:setExtractionListInfoì˜ isEquip nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= num, "PaGlobal_Extraction_Crystal_All:setExtractionListInfoì˜ num nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == itemSSW then
    return
  end
...
function PaGlobal_Extraction_Crystal_All:filterInvenCrystalItem(slotNo, itemWrapper, whereType)
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Extraction_Crystal_All:filterInvenCrystalItemì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function PaGlobal_Extraction_Crystal_All:setMaterialListInfo(slotNo, whereType, itemSSW)
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Extraction_Crystal_All:setMaterialListInfoì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= whereType, "PaGlobal_Extraction_Crystal_All:setMaterialListInfoì˜ whereType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == itemSSW then
    return
  end
...
function PaGlobal_Extraction_Crystal_All:filterMaterialItem(slotNo, whereType, itemWrapper)
  ...
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Extraction_Crystal_All:filterMaterialItemì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= whereType, "PaGlobal_Extraction_Crystal_All:filterMaterialItemì˜ whereType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function PaGlobal_Extraction_Crystal_All:setExtractionIcon(itemWrapper, slotNo)
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Extraction_Crystal_All:setExtractionIconì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == itemWrapper then
    self:clearAllSlot()
    return
  end
...
function PaGlobal_Extraction_Crystal_All:setMaterialSlotIcon(itemWrapper, whereType, slotNo)
  UI.ASSERT_NAME(nil ~= whereType, "PaGlobal_Extraction_Crystal_All:setMaterialSlotIconì˜ whereType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Extraction_Crystal_All:setMaterialSlotIconì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
