...
function PaGlobal_Extraction_Caphras_All:setExtractionPrice(caphraCnt, price)
  UI.ASSERT_NAME(nil ~= price, "PaGlobal_Extraction_Caphras_All:setExtractionPriceì˜ price nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= caphraCnt, "PaGlobal_Extraction_Caphras_All:setExtractionPriceì˜ caphraCnt nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == Panel_Window_Extraction_Caphras_All then
    return
  end
