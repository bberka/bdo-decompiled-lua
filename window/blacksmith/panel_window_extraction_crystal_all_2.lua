...
function HandleEventOn_Extraction_Crystal_All_ShowToolTip(key, isShow)
  UI.ASSERT_NAME(nil ~= key, "HandleEventOn_Extraction_Crystal_All_ShowToolTipì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= isShow, "HandleEventOn_Extraction_Crystal_All_ShowToolTipì˜ isShow nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventOn_Extraction_Crystal_All_ShowListToolTip(isEquip, idx, whereType, isShow)
  UI.ASSERT_NAME(nil ~= isEquip, "HandleEventOn_Extraction_Crystal_All_ShowListToolTipì˜ isEquip nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= idx, "HandleEventOn_Extraction_Crystal_All_ShowListToolTipì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Crystal_All_CrystalItem(key)
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_Crystal_All_CrystalItemì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Crystal_All_MaterialItem(key)
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_Crystal_All_MaterialItemì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  PaGlobal_Extraction_Crystal_All:clearMaterialSlot()
...
function HandleEventLUp_Extraction_Crystal_All_EquipItem(equipNo)
  UI.ASSERT_NAME(nil ~= equipNo, "HandleEventLUp_Extraction_Crystal_All_EquipItemì˜ equipNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Crystal_All_ExtractionListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Extraction_Crystal_All_ExtractionListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_Crystal_All_ExtractionListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Crystal_All_ExtractionCrystal(idx)
  UI.ASSERT_NAME(nil ~= idx, "HandleEventLUp_Extraction_Crystal_All_ExtractionCrystalì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Extraction_Crystal_All_MaterialListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Extraction_Crystal_All_MaterialListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Extraction_Crystal_All_MaterialListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  local key_32 = Int64toInt32(key)
...
function HandleEventRUp_Extraction_Crystal_All_RemoveCrystal(idx)
  UI.ASSERT_NAME(nil ~= idx, "HandleEventRUp_Extraction_Crystal_All_RemoveCrystalì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
