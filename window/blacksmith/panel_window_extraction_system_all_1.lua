...
function PaGlobal_Extraction_System_All:setExtractionIcon(itemWrapper, slotNo)
  UI.ASSERT_NAME(nil ~= itemWrapper, "PaGlobal_Extraction_System_All:setExtractionIconì˜ itemWrapper nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Extraction_System_All:setExtractionIconì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == Panel_Window_Extraction_System_All then
    return
  end
