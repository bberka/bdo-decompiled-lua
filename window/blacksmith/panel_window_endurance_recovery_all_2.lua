...
function HandleEventLUp_Endurance_Recovery_All_RecoveryItem(key)
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Endurance_Recovery_All_RecoveryItemì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  PaGlobal_Endurance_Recovery_All._isStreamRecovery = false
  local slotNo = PaGlobal_Endurance_Recovery_All._recoveryItemInfo.slotNo[key]
...
function HandleEventLUp_Endurance_Recovery_All_MaterialItem(key)
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Endurance_Recovery_All_MaterialItemì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Endurance_Recovery_All_EquipmentItem(equipNo)
  UI.ASSERT_NAME(nil ~= equipNo, "HandleEventLUp_Endurance_Recovery_All_equipmentItemì˜ equipNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if false == _ContentsGroup_RenewUI_InventoryEquip then
    if true == _ContentsGroup_NewUI_Equipment_All then
...
function HandleEventLUp_Endurance_Recovery_All_RecoveryListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Endurance_Recovery_All_RecoveryListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Endurance_Recovery_All_RecoveryListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Endurance_Recovery_All_MaterialListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Endurance_Recovery_All_MaterialListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Endurance_Recovery_All_MaterialListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  local key_32 = Int64toInt32(key)
...
function HandleEventOn_Endurance_Recovery_All_ShowCashItemToolTip(isShow, isCashToolTip)
  UI.ASSERT_NAME(nil ~= isShow, "HandleEventOn_Endurance_Recovery_All_ShowCashItemToolTipì˜ isShow nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= isCashToolTip, "HandleEventOn_Endurance_Recovery_All_ShowCashItemToolTipì˜ isCashToolTip nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventOn_Endurance_Recovery_All_ShowToolTip(key, isShow)
  UI.ASSERT_NAME(nil ~= key, "HandleEventOn_Endurance_System_All_ShowToolTipì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function PaGlobal_Endurance_Recovery_All_FilterMaterialItem(slotNo, whereType, itemWrapper)
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Endurance_Recovery_All_FilterMaterialItemì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= whereType, "PaGlobal_Endurance_Recovery_All_FilterMaterialItemì˜ whereType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= itemWrapper, "PaGlobal_Endurance_Recovery_All_FilterMaterialItemì˜ itemWrapper nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == itemWrapper then
    return true
  end
...
function PaGlobal_Endurance_Recovery_All_FixEquipContinue(slotNo)
  UI.ASSERT_NAME(nil ~= slotNo, "PaGlobal_Endurance_Recovery_All_FixEquipContinueì˜ slotNo nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  local selfPlayer = getSelfPlayer()
