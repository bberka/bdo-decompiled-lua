function PaGlobal_CharInfoTitle_All:initialize()
  ...
  UI.ASSERT_NAME(nil ~= self._selfPlayer, " Panel_CharacterInfo_Title_All_1.lua / getSelfPlayer() is nil", "±è±Ù¿ì")
...
function PaGlobal_CharInfoTitle_All:update()
  ...
  if false == PaGlobal_ChracterInfo_All_GetLPress() then
    ...
    if nil == self._ui.stc_prog2Table then
      UI.ASSERT_NAME(nil ~= self._ui.stc_prog2Table, " Panel_CharacterInfo_Title_All_1.lua / stc_prog2Table is nil", "±è±Ù¿ì")
      return
    end
  end
  for categoryIdx = 0, 3 do
    if nil == self._ui.stc_prog2Table[categoryIdx] then
      UI.ASSERT_NAME(nil ~= self._ui.stc_prog2Table[categoryIdx], " Panel_CharacterInfo_Title_All_1.lua / self._ui.stc_prog2Table[" .. categoryIdx .. "] is nil", "±è±Ù¿ì")
      return
    end
