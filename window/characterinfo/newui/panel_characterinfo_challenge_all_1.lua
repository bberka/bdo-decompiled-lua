function PaGlobal_CharInfoChallenge_All:initialize()
  ...
  self._ui.stc_eventBanner = UI.getChildControl(Panel_CharacterInfoChallenge_All, "Static_EventBanner")
  ...
  self._ui.stc_solareBanner = UI.getChildControl(Panel_CharacterInfoChallenge_All, "Static_Solare_Banner")
