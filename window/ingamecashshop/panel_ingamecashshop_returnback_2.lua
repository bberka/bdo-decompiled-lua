...
function HandleEventOnOut_IngameCashSHop_ReturnBack_ItemShowToolTipForEventCart(isShow, productNo, controlIndex, index)
  if false == isShow then
    Panel_Tooltip_Item_hideTooltip()
    return
  end
  ...
  if PaGlobal_IngameCashSHop_ReturnBack._subSlotForEvent[controlIndex] == nil then
    return
  end
  if PaGlobal_IngameCashSHop_ReturnBack._subSlotForEvent[controlIndex].slot[index] == nil then
    return
  end
  Panel_Tooltip_Item_Show(itemSSW, PaGlobal_IngameCashSHop_ReturnBack._subSlotForEvent[controlIndex].slot[index], true)
end
