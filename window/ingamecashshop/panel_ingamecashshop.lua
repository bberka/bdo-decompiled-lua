...
function inGameShop:init()
  ...
  local newClassType = __eClassType_Drakania
  local newClassContentsGroupOpen = ToClient_IsContentsGroupOpen("1600")
...
function setPosOpenSubTab(tabIndex)
  ...
  if _ContentsGroup_RefundCashProduct == true then
    ...
    if false == self._isHotDealOpen then
      ...
      self._historyTab.static:SetPosY(tabConfig._startY + subTabSize + tabConfig._gapY * (tabId.history - (1 + self._hideTabCount)))
    end
  end
...
function setPosCloseSubTab()
  ...
  if _ContentsGroup_RefundCashProduct == true then
    ...
    if false == self._isHotDealOpen then
      ...
      self._historyTab.static:SetPosY(tabConfig._startY + tabConfig._gapY * (tabId.history - (1 + self._hideTabCount)))
    end
  end
...
function IngameCashShop_DescUpdate()
  ...
  if isGameTypeKR2() == true then
    self._staticText_PolicyDesc:SetShow(false)
  elseif true == cashProduct:isDisplayCashProductPolicy() then
  ...
  if false == isBuyShow and false == isBuyable then
    self._btn_BigBuy:addInputEvent("Mouse_LUp", "InGameShop_BuyConditionGuideMessageOpen()")
    self._btn_BigBuy_C:addInputEvent("Mouse_LUp", "InGameShop_BuyConditionGuideMessageOpen()")
    self._btn_BigBuy_M:addInputEvent("Mouse_LUp", "InGameShop_BuyConditionGuideMessageOpen()")
    self._btn_BigBuy_Silver:addInputEvent("Mouse_LUp", "InGameShop_BuyConditionGuideMessageOpen()")
  else
  ...
  if isGameTypeKR2() == true and UI_CCC.eCashProductCategory_Mileage == cashProduct:getMainCategory() then
    self._btn_BigCart:SetShow(false)
    self._btn_BigGift:SetShow(false)
  end
...
function InGameShop_BuyConditionGuideMessageOpen()
  local messageBoxData = {
...
function InGameShop_Resize()
  ...
  if _ContentsGroup_RefundCashProduct == true then
    if true == self._isHotDealOpen then
      self._historyTab.static:SetPosY(tabConfig._startY + tabConfig._gapY * (tabId.history - 2))
    else
