...
function inGameShopBuy:updateByEventCart()
  ...
  self._static_BuyLineBG:SetPosY(buyConfig._startY + buyConfig._gapX + 30 + noticeSizeY)
  if self._isGift then
    self._static_BuyLineBG:SetShow(false)
    self._static_LeftBG:SetSize(self._static_LeftBG:GetSizeX(), buyConfig._startY + buyConfig._gapX + noticeSizeY)
    Panel_IngameCashShop_BuyOrGift:SetSize(Panel_IngameCashShop_BuyOrGift:GetSizeX(), 620 + buyConfig._gapX + noticeSizeY)
    self._static_GiftListBG:SetPosY(200 + buyConfig._gapX + noticeSizeY)
    self._static_GiftListTopBG:SetPosY(205 + buyConfig._gapX + noticeSizeY)
    self._static_GiftListMiddleBG:SetPosY(300 + buyConfig._gapX + noticeSizeY)
    self._static_GiftListBotBG:SetPosY(355 + buyConfig._gapX + noticeSizeY)
    ...
    self._static_LeftBG:SetSize(self._static_LeftBG:GetSizeX(), buyConfig._startY + buyConfig._gapX + noticeSizeY)
    self._static_PearlBG:SetPosY(250 + noticeSizeY)
    ...
    Panel_IngameCashShop_BuyOrGift:SetSize(Panel_IngameCashShop_BuyOrGift:GetSizeX(), buyConfig._startY + buyConfig._gapX + self._config._sizePanel + self._static_PearlBG:GetSizeY() + 40 + noticeSizeY)
...
function inGameShopBuy:update(isCouponApply)
  ...
  if self._isGift then
    self._static_BuyLineBG:SetShow(false)
    self._static_LeftBG:SetSize(self._static_LeftBG:GetSizeX(), 130 + noticeSizeY)
    Panel_IngameCashShop_BuyOrGift:SetSize(Panel_IngameCashShop_BuyOrGift:GetSizeX(), 620 + noticeSizeY)
    self._static_GiftListBG:SetPosY(200 + noticeSizeY)
    self._static_GiftListTopBG:SetPosY(205 + noticeSizeY)
    self._static_GiftListMiddleBG:SetPosY(300 + noticeSizeY)
    self._static_GiftListBotBG:SetPosY(355 + noticeSizeY)
    self._static_GiftListBG:SetShow(true)
    self._static_GiftListTopBG:SetShow(true)
    self._static_GiftListMiddleBG:SetShow(true)
    self._static_GiftListBotBG:SetShow(true)
    ...
    self._txt_CouponApplyIcon:ComputePos()
    local couponBGSizeX = self._static_CouponApplyBG:GetSizeX()
    Panel_IngameCashShop_BuyOrGift:SetSize(Panel_IngameCashShop_BuyOrGift:GetSizeX(), buyConfig._startY + buyConfig._gapX + self._config._sizePanel + self._static_PearlBG:GetSizeY() + giftGap + 40 + noticeSizeY)
    local pearlIconPriceByCoupon = self._static_PearlBG:GetPosY() + self._static_PearlBG:GetSizeY() / 2 - self._txt_PearlIconPrice:GetSizeY() / 2
    self._static_PearlBG:SetShow(true)
    self._static_GiftListBG:SetShow(false)
    self._static_GiftListTopBG:SetShow(false)
...
function FGlobal_IngameCashShop_BuyOrGift_SetPearlStampValue(price, moneyType)
  ...
  if false == self._static_CouponApplyBG:GetShow() and stampCount <= userStampCount and true == isOpenPearlStamp and moneyType ~= UI_CCC.eCashProductCategory_Pearl and moneyType ~= UI_CCC.eCashProductCategory_Mileage then
    ...
    Panel_IngameCashShop_BuyOrGift:SetSize(Panel_IngameCashShop_BuyOrGift:GetSizeX(), buyConfig._startY + buyConfig._gapX + self._config._sizePanel + self._static_PearlBG:GetSizeY() + 40 + self._static_selectStampBG:GetSizeY() + noticeSizeY)
    ...
    Panel_IngameCashShop_BuyOrGift:SetSize(Panel_IngameCashShop_BuyOrGift:GetSizeX(), buyConfig._startY + buyConfig._gapX + self._config._sizePanel + self._static_PearlBG:GetSizeY() + 40 + addSizeY + noticeSizeY)
...
function HandleClicked_AddGiftTopList(botIdx)
  ...
  if "" ~= botName or nil ~= botName then
    ...
    _PA_ASSERT(false, "ë°ì´í„°ê°€ ë¹„ì •ìƒì…ë‹ˆë‹¤. giftUserList ë°°ì—´ì— í•´ë‹¹í•˜ëŠ” idx í˜¹ì€ name ê°’ì´ ì—†ìŠµë‹ˆë‹¤.")
  end
  if inGameShopBuy._eventCart then
