...
function pearlShopProductBuy:initialize()
  ...
  self._ui._noticeControl = UI.getChildControl(mainBgControl, "StaticText_Notice")
...
<PAColor0xFFF26A6A>]] .. policyDesc .. "<PAOldColor>"
  ...
  if addSize > 20 then
    self._panel:SetSize(512, 572 + addSize + self._noticeSizeY)
    self._ui.TopBg:SetSize(472, 256 + addSize + self._noticeSizeY)
    ...
    self._ui._mainBG:SetSize(502, 400 + addSize + self._noticeSizeY)
  else
    self._panel:SetSize(512, 664 + self._noticeSizeY)
    self._ui._descControl:SetSize(390, 20)
    self._ui._descControl:SetPosY(235 + addPosY)
    self._ui._mainBG:SetSize(502, 450 + self._noticeSizeY)
