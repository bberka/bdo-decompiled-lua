  ...
  for i = 0, self._ui._itemSlotControlListSize - 1 do
    ...
    if showFlag then
      ...
      if i == self._focusedIndex then
        ...
        focusedItemInfo:updateLocalDataAll()
      end
    end
  end
...
function FromClient_PearlShopProductInfo_ItemLocalUpdated(itemKey)
  if true == pearlShopProductInfo:checkShow() then
    pearlShopProductInfo:update()
  end
end
registerEvent("FromClient_luaLoadComplete", "FromClient_PearlShopProductInfoInit")
registerEvent("FromClient_ItemLocalUpdated", "FromClient_PearlShopProductInfo_ItemLocalUpdated")
