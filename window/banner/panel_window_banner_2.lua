...
function PaGlobal_Banner_GetEventPageMoveURL()
  ...
  elseif CppEnums.CountryType.SA_REAL == getGameServiceType() or CppEnums.CountryType.SA_ALPHA == getGameServiceType() then
    url = "https://www.sa.playblackdesert.com/News/Notice"
  ...
  elseif CppEnums.CountryType.JPN_REAL == getGameServiceType() or CppEnums.CountryType.JPN_ALPHA == getGameServiceType() then
    url = "https://www.jp.playblackdesert.com/News/Notice"
  else
    url = ""
  end
  return url
...
function PaGlobalFunc_InGameBannerSolare()
  ...
  local url = "https://www.kr.playblackdesert.com/ko-KR/News/Detail"
  if true == isGameTypeTaiwan() then
    url = "https://www.tw.playblackdesert.com/News/Notice/Detail"
  elseif true == isGameTypeTR() then
    url = "https://www.tr.playblackdesert.com/News/Notice/Detail"
  elseif true == isGameTypeID() then
    url = "https://www.sea.playblackdesert.com/News/Notice/Detail"
  elseif true == isGameTypeRussia() then
    url = "https://www.ru.playblackdesert.com/News/Notice/Detail"
  elseif true == isGameTypeJapan() then
    url = "https://www.jp.playblackdesert.com/News/Notice/Detail"
  elseif true == isGameTypeEnglish() then
    url = "https://www.naeu.playblackdesert.com/News/Detail"
  elseif true == isGameTypeSA() then
    url = "https://www.sa.playblackdesert.com/News/Detail"
  elseif true == isGameTypeTH() then
    url = "https://www.th.playblackdesert.com/News/Notice/Detail"
  end
