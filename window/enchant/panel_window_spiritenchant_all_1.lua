...
function PaGlobal_SpiritEnchant_All:setItemToSlot(uiSlot, slotNo, itemWrapper, inventoryType, enchantLevel)
  ...
  if true == itemSSW:get()._isChangeEquipItem and true == isSeasonCharacter then
...
function PaGlobal_SpiritEnchant_All:controlLightStone_Init()
  UI.ASSERT_NAME(nil ~= self._ui_enchant.stc_imageArea, "self._ui_enchant.stc_imageArea is nil", "ë°•ê·œë‚˜")
