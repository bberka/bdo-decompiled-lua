...
function PaGlobal_CollectToolBox_All:prepareOpen()
  ...
  if Panel_Window_Inventory_All ~= nil then
    if false == Panel_Window_Inventory_All:IsUISubApp() then
      Panel_Window_CollectToolBox_All:SetPosX(Panel_Window_Inventory_All:GetPosX() - Panel_Window_CollectToolBox_All:GetSizeX() - 5)
...
function PaGlobal_CollectToolBox_All:update()
  ...
  for idx = 1, #self._collectTypeList do
    ...
    if itemWrapper ~= nil then
      ...
      elseif 0 < enchantLevel and itemStaticStatus:getItemClassify() == CppEnums.ItemClassifyType.eItemClassify_Accessory and itemStaticStatus:isSpecialEnchantItem() == false then
