...
function PaGlobal_SimpleInventory:open(characterNo_s64)
  ...
  PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(InvenSortLinkPanelIndex.AnotherCharacterInventory, Panel_Window_SimpleInventory, PaGlobal_SimpleInventory._ui._btn_sortOption, PaGlobal_SimpleInventory._ui._chk_sortButton)
...
function PaGlobal_SimpleInventory:validate()
  if nil == Panel_Window_SimpleInventory then
    UI.ASSERT_NAME(false, "Panel_Window_SimpleInventoryì´ ë¡œë“œë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤.", "ìš°ì •ë¬´")
    return
  end
