...
function PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(panelIndex, panel, sortButtonControl, sortCheckButtonControl, sortComponentControlAddString)
  local self = PaGlobal_InvenAutoSort
  if self == nil then
    return
  end
  self:linkPanel(panelIndex, panel, sortButtonControl, sortCheckButtonControl, sortComponentControlAddString)
end
