...
function FromClient_Inventory_All_RenderModeChange_FlushRestoreFunc(prevRenderModeList, nextRenderModeList)
  ...
  if CheckRenderModebyGameMode(nextRenderModeList) == false then
    ...
    PaGlobal_Inventory_All._ui.btn_lightStoneBag:SetEnable(true)
    PaGlobal_Inventory_All._ui.btn_lightStoneBag:SetIgnore(false)
    PaGlobal_Inventory_All._ui.btn_lightStoneBag:SetMonoTone(false)
    PaGlobal_Inventory_All._ui.btn_toolBox:SetEnable(true)
    PaGlobal_Inventory_All._ui.btn_toolBox:SetIgnore(false)
    PaGlobal_Inventory_All._ui.btn_toolBox:SetMonoTone(false)
