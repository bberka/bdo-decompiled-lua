...
function InventoryWindow_Show(uiType, isCashInven, isMarket, isFamilyInven)
  ...
  PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(InvenSortLinkPanelIndex.Inventory, Panel_Window_Inventory_All, PaGlobal_Inventory_All._ui.button_sortOption, PaGlobal_Inventory_All._ui.btn_checkSort)
