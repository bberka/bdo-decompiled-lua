...
function PaGlobal_FamilyInventory_All:prepareOpen()
  ...
  PaGlobalFunc_AutoSortFunctionPanel_LinkPanel(InvenSortLinkPanelIndex.FamilyInventory, Panel_Window_FamilyInventory_All, PaGlobal_FamilyInventory_All._ui._btn_sortOption, PaGlobal_FamilyInventory_All._ui._chkSort)
