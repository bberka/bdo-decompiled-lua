...
function PaGlobal_LightStoneBag:convert_itemGradeColor(grade)
  if 0 == grade then
...
function PaGlobal_LightStoneBag:createArtifactBagListContent(content, s64_key)
  ...
  if artifactItemSSW == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:createArtifactBagListContent] ìœ ë¬¼ ê°€ë°©ì— ìˆëŠ” ì•„ì´í…œ ì •ë³´ê°€ ë¹„ì •ìƒì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
  ...
  if self._isConsole == true then
    ...
    btn_slot:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobalFunc_ArtifactBag_ShowItemTooltip(true," .. tostring(s64_key) .. ")")
  else
...
function PaGlobal_LightStoneBag:createArtifactPresetListContent(content, s64_key)
  ...
  if PaGlobalFunc_ArtifactTooltip_Show_ForArtifactPreset ~= nil then
    if self._isConsole == true then
      btn_preset:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_ArtifactTooltip_Show_ForArtifactPreset(true," .. tostring(presetNo) .. ")")
    else
...
function PaGlobal_LightStoneBag:createLightStoneBagListContent(content, s64_key)
  ...
  if lightStoneItemSSW == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:createLightStoneBagListContent] ê´‘ëª…ì„ ê°€ë°©ì— ìˆëŠ” ì•„ì´í…œ ì •ë³´ê°€ ë¹„ì •ìƒì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
  local btn_item = UI.getChildControl(content, "Button_LightStone")
  local stc_itemSlotBg = UI.getChildControl(btn_item, "Static_ItemSlotBG")
  ...
  if self._isConsole == true then
    ...
    btn_item:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobalFunc_LightStoneBag_ShowItemTooltip(true," .. tostring(s64_key) .. ")")
  else
...
function PaGlobal_LightStoneBag:changePadSnapState(newState, isForceChange)
  ...
  if newState ~= LightStoneBagConsoleSnapState.SnapOnBag and newState ~= LightStoneBagConsoleSnapState.SnapOnPreset and newState ~= LightStoneBagConsoleSnapState.SnapOnEditMode then
    UI.ASSERT_NAME(false, "ì •ì˜ë˜ì§€ ì•Šì€ PadSnapState ì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
...
function PaGlobal_LightStoneBag:resyncKeyGuideState()
  ...
  elseif self._currentPadSnapState == LightStoneBagConsoleSnapState.SnapOnEditMode then
    ...
    UI.ASSERT_NAME(false, "í˜„ì¬ self._currentPadSnapStateì˜ ê°’ì— ëŒ€í•œ ì²˜ë¦¬ê°€ ì •ì˜ë˜ì§€ ì•Šì•˜ìŠµë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
...
function PaGlobal_LightStoneBag:onClickedTab(tabIndex)
  ...
  elseif tabIndex == LightStoneBagTabIndex.LightStone then
    ...
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:onClickedTab] Tab Indexê°€ ë¹„ì •ìƒì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
  ClearFocusEdit()
...
function PaGlobal_LightStoneBag:reloadList_lightStoneBagList(isHoldScroll)
  ...
  if listManager == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:reloadList_lightStoneBagList] ê´‘ëª…ì„ ê°€ë°©ì˜ ListManagerê°€ nilì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
  ...
  if isHoldScroll ~= nil and isHoldScroll == true then
    self._ui._lightStoneBagList:setCurrenttoIndex(currentScrollIndex)
...
function PaGlobal_LightStoneBag:simpleReloadList_lightStoneBagList()
  ...
  local listManager = self._ui._lightStoneBagList:getElementManager()
  if listManager == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:simpleReloadList_lightStoneBagList] ê´‘ëª…ì„ ê°€ë°©ì˜ ListManagerê°€ nilì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
...
function PaGlobal_LightStoneBag:reloadList_artifactBagList(isHoldScroll)
  ...
  if listManager == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:reloadList_artifactBagList] ìœ ë¬¼ ê°€ë°©ì˜ ListManagerê°€ nilì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
  ...
  if isHoldScroll ~= nil and isHoldScroll == true then
    self._ui._artifactBagList:setCurrenttoIndex(currentScrollIndex)
...
function PaGlobal_LightStoneBag:simpleReloadList_artifactBagList()
  ...
  local listManager = self._ui._artifactBagList:getElementManager()
  if listManager == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:simpleReloadList_artifactBagList] ìœ ë¬¼ ê°€ë°©ì˜ ListManagerê°€ nilì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
...
function PaGlobal_LightStoneBag:reloadList_artifactPresetList(isHoldScroll)
  ...
  if listManager == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:reloadList_artifactPresetList] ìœ ë¬¼ í”„ë¦¬ì…‹ì˜ ListManagerê°€ nilì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
...
function PaGlobal_LightStoneBag:simpleReloadList_artifactPresetList()
  ...
  local listManager = self._ui._artifactPresetList:getElementManager()
  if listManager == nil then
    UI.ASSERT_NAME(false, "[PaGlobal_LightStoneBag:simpleReloadList_artifactPresetList] ìœ ë¬¼ í”„ë¦¬ì…‹ì˜ ListManagerê°€ nilì…ë‹ˆë‹¤.", "ì´ì£¼")
    return
  end
