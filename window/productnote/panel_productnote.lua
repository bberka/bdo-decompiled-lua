...
function Panel_ProductNote_ShowToggle()
  ...
  if isShow == true then
    ...
    PaGlobal_ProductNote._productWeb:SetUrl(PaGlobal_ProductNote._sizeX, PaGlobal_ProductNote._sizeY, "coui://UI_Data/UI_Html/Window/ProductNote/ProductNote_CategoryItemList.html")
...
function ProductNote_Item_ShowToggle(itemKey)
  ...
  if isShow == true then
    ...
    Panel_ProductNote:SetShow(true, true)
    FGlobal_SetCandidate()
    PaGlobal_ProductNote._productWeb:SetUrl(PaGlobal_ProductNote._sizeX, PaGlobal_ProductNote._sizeY, "coui://UI_Data/UI_Html/Window/ProductNote/ProductNote_CategoryItemList.html" .. itemKey)
    PaGlobal_ProductNote._productWeb:SetIME(true)
  end
end
