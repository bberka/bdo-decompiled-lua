...
function Panel_ProductNote_ShowToggle()
  ...
  if isShow == true then
    ...
    if true == _ContentsGroup_ConsoleIntegration then
      ...
      url = "coui://UI_Data/UI_Html/Window/ProductNote/ProductNote_CategoryItemList.html"
    end
...
function ProductNote_Item_ShowToggle(itemKey)
  ...
  if isShow == true then
    ...
    if true == _ContentsGroup_ConsoleIntegration then
      ...
      url = "coui://UI_Data/UI_Html/Window/ProductNote/ProductNote_CategoryItemList.html" .. "platform=" .. platform .. "&" .. itemKey
    else
      url = "coui://UI_Data/UI_Html/Window/ProductNote/ProductNote_CategoryItemList.html" .. itemKey
    end
    _productWeb:SetUrl(sizeX, sizeY, url)
    _productWeb:SetIME(true)
  end
