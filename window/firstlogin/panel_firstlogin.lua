...
function FirstLogin:SetStepEnd()
  ...
  local function tutorialSkipEnterGame()
    if _ContentsGroup_SelectStartPosition == true then
      ...
      ToClient_NewSequenceTutorialSkipChangeStartPosition(true, false, FirstLogin.characterSelect)
    end
  end
  local function enterTutorial()
    PaGlobal_CharacterSelect_All._selectedCharIdx = FirstLogin.characterSelect
    ToClient_NewSequenceTutorialSkipChangeStartPosition(false, false, PaGlobal_CharacterSelect_All._selectedCharIdx)
  end
  if true == _ContentsGroup_NewSequenceTutorial then
    ...
    local characterData = getCharacterDataByIndex(FirstLogin.characterSelect, false)
