...
local constValue = {
  buffTypeString = {
    ...
    [23] = PAGetString(Defines.StringSheet_GAME, "MENTALGAME_BUFFTYPE_DEMANDINGFAVOR")
  },
...
function Panel_Knowledge_AddItemTree(parentUIItem, theme)
  ...
  if maxInceaseWp > 0 then
    ...
    if true == isGameTypeKR2() and maxKnowledgeNeedCount > maxPossibleCollectCount then
