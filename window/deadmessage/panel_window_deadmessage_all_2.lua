...
function FromClient_DeadMessage_All_DestroyJewel(destoryJewel01, destoryJewel02, destoryJewel03, destoryJewel04, destoryJewel05)
  ...
  for idx = 0, #jewelKey do
    if nil ~= jewelKey[idx] and 0 ~= jewelKey[idx] then
      local itemEnchantSS = getItemEnchantStaticStatus(ItemEnchantKey(jewelKey[idx]))
...
function PaGlobalFunc_DeadMessage_All_ButtonPushEvent_AbyssOneExit()
  ...
  deadMessage_Revival(__eRespawnType_AbyssOneExit, 255, 0, getSelfPlayer():getRegionKey(), false, toInt64(0, 0))
end
function PaGlobalFunc_DeadMessage_All_ButtonPushEvent_AbyssOneBase()
  ...
  deadMessage_Revival(__eRespawnType_AbyssOneBase, 255, 0, getSelfPlayer():getRegionKey(), false, toInt64(0, 0))
end
function PaGlobalFunc_DeadMessage_All_ButtonPushEvent_AbyssOne()
  ...
  deadMessage_Revival(__eRespawnType_AbyssOne, 255, 0, getSelfPlayer():getRegionKey(), false, toInt64(0, 0))
end
