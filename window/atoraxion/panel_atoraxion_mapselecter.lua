...
function PaGlobal_Atoraxion_MapSelecter:registEventHandler()
  ...
  if true == ToClient_IsContentsGroupOpen("774") then
    self._ui.mapSelectBtn[3]._rdoBtn:addInputEvent("Mouse_LUp", "HandleEventLUp_Atoraxion_MapSelecter_MapSelect(" .. __eInstanceAtoraxionValley_Hadum .. ")")
  end
