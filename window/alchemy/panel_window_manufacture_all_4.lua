...
function HandleEventLUp_Manufacture_All_StartManufacture()
  ...
  local RGManufacture = PaGlobal_Manufacture_All.MANUFACTURE_TYPE.RGCOOK == PaGlobal_Manufacture_All._actionIndex or PaGlobal_Manufacture_All.MANUFACTURE_TYPE.RGALCHEMY == PaGlobal_Manufacture_All._actionIndex
