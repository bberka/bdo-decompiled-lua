...
function PaGlobal_Levelup_Info_All:additionalStatShowOff(lvdd, lvpv)
  ...
  UI.ASSERT_NAME(nil ~= lvdd, "PaGlobal_Levelup_Info_All:additionalStatShowOff lvdd nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= lvpv, "PaGlobal_Levelup_Info_All:additionalStatShowOff lvpv nil", "ì´ìŠ¹í™˜")
  if 0 == lvdd then
...
function PaGlobal_Levelup_Info_All:calculateStatBGResize(lvdd, lvpv)
  ...
  UI.ASSERT_NAME(nil ~= lvdd, "PaGlobal_Levelup_Info_All:calculateStatBGResize lvdd nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= lvpv, "PaGlobal_Levelup_Info_All:calculateStatBGResize lvpv nil", "ì´ìŠ¹í™˜")
  local addSizeY = 0
...
function PaGlobal_Levelup_Info_All:calculateTopResize(index)
  ...
  UI.ASSERT_NAME(nil ~= index, "PaGlobal_Levelup_Info_All:calculateTopResize index nil", "ì´ìŠ¹í™˜")
...
function PaGlobal_Levelup_Info_All:calculateBottomResize(index)
  ...
  UI.ASSERT_NAME(nil ~= index, "PaGlobal_Levelup_Info_All:calculateBottomResize index nil", "ì´ìŠ¹í™˜")
