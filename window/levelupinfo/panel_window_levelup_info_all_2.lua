...
function PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo(learnableSkillCount, learnSkillCount, hp, mp, stun, weight, lvdd, lvpv)
  ...
  UI.ASSERT_NAME(nil ~= learnSkillCount, "PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo learnSkillCount nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= learnableSkillCount, "PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo learnableSkillCount nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= hp, "PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo hp nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= mp, "PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo mp nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= weight, "PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo weight nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= lvdd, "PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo lvdd nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= lvpv, "PaGlobalFunc_Levelup_Info_All_SelfPlayerCurrentLevelInfo lvpv nil", "ì´ìŠ¹í™˜")
...
function PaGlobalFunc_Levelup_Info_All_SelfPlayerLevelUp_StatusDataSet(hp, mp, stun, weight, lvdd, lvpv)
  ...
  UI.ASSERT_NAME(nil ~= hp, "PaGlobalFunc_Levelup_Info_All_SelfPlayerLevelUp_StatusDataSet hp nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= mp, "PaGlobalFunc_Levelup_Info_All_SelfPlayerLevelUp_StatusDataSet mp nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= weight, "PaGlobalFunc_Levelup_Info_All_SelfPlayerLevelUp_StatusDataSet weight nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= lvdd, "PaGlobalFunc_Levelup_Info_All_SelfPlayerLevelUp_StatusDataSet lvdd nil", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= lvpv, "PaGlobalFunc_Levelup_Info_All_SelfPlayerLevelUp_StatusDataSet lvpv nil", "ì´ìŠ¹í™˜")
...
function PaGlobalFunc_Levelup_Info_All_LearnableSkillDataSet(skillNo, index, needSkillPoint)
  ...
  UI.ASSERT_NAME(nil ~= skillNo, "skillNoê°€ nilì…ë‹ˆë‹¤.", "ì´ìŠ¹í™˜")
  UI.ASSERT_NAME(nil ~= index, "indexê°€ nilì…ë‹ˆë‹¤.", "ì´ìŠ¹í™˜")
