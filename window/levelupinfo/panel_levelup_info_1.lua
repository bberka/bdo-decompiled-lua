...
function PaGlobal_LevelupInfo:additionalStatShowOff(lvdd, lvpv)
  UI.ASSERT_NAME(nil ~= lvdd, "PaGlobal_LevelupInfo:additionalStatShowOff lvdd nil", "ìš°ì •ë¬´")
  UI.ASSERT_NAME(nil ~= lvpv, "PaGlobal_LevelupInfo:additionalStatShowOff lvpv nil", "ìš°ì •ë¬´")
  if 0 == lvdd then
...
function PaGlobal_LevelupInfo:calculateStatResize(lvdd, lvpv)
  UI.ASSERT_NAME(nil ~= lvdd, "PaGlobal_LevelupInfo:calculateStatResize lvdd nil", "ìš°ì •ë¬´")
  UI.ASSERT_NAME(nil ~= lvpv, "PaGlobal_LevelupInfo:calculateStatResize lvpv nil", "ìš°ì •ë¬´")
  local addSizeY = 0
  local textSizeY = PaGlobal_LevelupInfo._ui._txt_maxHpTitle:GetSizeY()
  if 0 ~= lvdd then
...
function PaGlobal_LevelupInfo:calculateTopResize(index)
  UI.ASSERT_NAME(nil ~= index, "PaGlobal_LevelupInfo:calculateTopResize index nil", "ì²œë§Œê¸°")
...
function PaGlobal_LevelupInfo:calculateBottomResize(index)
  UI.ASSERT_NAME(nil ~= index, "PaGlobal_LevelupInfo:calculateBottomResize index nil", "ì²œë§Œê¸°")
