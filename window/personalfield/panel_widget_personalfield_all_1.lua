...
function PaGlobal_Widget_PersonalField_All:registEventHandler()
  ...
  registerEvent("FromClient_UpdatePersonalFieldState", "FromClient_Widget_PersonalField_All_UpdatePersonalFieldState")
...
function PaGlobal_Widget_PersonalField_All:updateData()
  ...
  if true == self._isSetAreaInfo and nil ~= self._index then
    ...
    if true == curChannelData._isEventChannel or true == curChannelData._isInstanceChannel then
      return false
    end
    ...
    if true == curChannelData._isDontPvPTendencyDecrease or true == curChannelData._isSiegeChannel then
...
function PaGlobal_Widget_PersonalField_All:updateServerState()
  ...
  if true == curChannelData._isSiegeChannel or true == curChannelData._isDontPvPTendencyDecrease or true == curChannelData._isEventChannel or true == curChannelData._isInstanceChannel then
    self._ui._btn_exit:SetShow(false)
    self._ui._txt_enter:SetShow(false)
    return
  end
