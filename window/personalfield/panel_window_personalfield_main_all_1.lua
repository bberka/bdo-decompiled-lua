...
function PaGlobal_PersonalField_Main_All:updateServerState()
  ...
  if true == curChannelData._isSiegeChannel or true == curChannelData._isDontPvPTendencyDecrease or true == curChannelData._isEventChannel then
...
function PaGlobal_PersonalField_Main_All:listControlCreate(content, key)
  ...
  self._naviPosList[index] = centerPos
