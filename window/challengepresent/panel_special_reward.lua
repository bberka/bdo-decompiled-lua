...
local isNewbie = function()
  return questList_hasProgressQuest(161, 1) or questList_hasProgressQuest(121, 1) or questList_hasProgressQuest(120, 1) or questList_hasProgressQuest(138, 1) or questList_hasProgressQuest(118, 1) or questList_hasProgressQuest(160, 1)
end
