...
function PaGlobal_GuildPanelLoad:setPanel(ePanelType, panel)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_GuildPanelLoad:setPanel ePanelType nil", "ì²œë§Œê¸°")
  UI.ASSERT_NAME(nil ~= panel, "PaGlobal_GuildPanelLoad:setPanel panel nil", "ì²œë§Œê¸°")
...
function PaGlobal_GuildPanelLoad:getPanel(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_GuildPanelLoad:getPanel ePanelType nil", "ì²œë§Œê¸°")
  if PaGlobal_GuildPanelLoad._eType._guildMain == ePanelType then
...
function PaGlobal_GuildPanelLoad:checkLoadUI(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_GuildPanelLoad:checkLoadUI ePanelType nil", "ì²œë§Œê¸°")
  local rv
  if PaGlobal_GuildPanelLoad._eType._guildMain == ePanelType then
...
function PaGlobal_GuildPanelLoad:initialize(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_GuildPanelLoad:initialize ePanelType nil", "ì²œë§Œê¸°")
  if PaGlobal_GuildPanelLoad._eType._guildMain == ePanelType then
...
function PaGlobal_GuildPanelLoad:checkCloseUI(ePanelType, isAni)
  ...
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_GuildPanelLoad:checkCloseUI ePanelType nil", "ì²œë§Œê¸°")
...
function PaGlobal_GuildPanelLoad:getShowPanel(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_GuildPanelLoad:getShowPanel ePanelType nil", "ì²œë§Œê¸°")
  local panel = PaGlobal_GuildPanelLoad:getPanel(ePanelType)
  if nil == panel then
    return false
  end
...
function PaGlobal_GuildPanelLoad:isUISubApp(ePanelType)
  UI.ASSERT_NAME(nil ~= ePanelType, "PaGlobal_GuildPanelLoad:isUISubApp ePanelType nil", "ì²œë§Œê¸°")
  local panel = PaGlobal_GuildPanelLoad:getPanel(ePanelType)
  if nil == panel then
    return false
  end
...
function PaGlobal_GuildPanelLoad_SetShowPanelGuildMain(isShow, isAni)
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_GuildPanelLoad_SetShowPanelGuildMain isShow nil", "ì²œë§Œê¸°")
