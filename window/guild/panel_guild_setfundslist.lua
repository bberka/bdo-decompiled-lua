...
function HandleClicked_GuildFundsSort(sortType)
  ...
  if 0 == sortType then
    if false == _listSort.name then
      self._title_CharName:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_CHARNAME") .. "â–²")
      _listSort.name = true
    else
      self._title_CharName:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_CHARNAME") .. "â–¼")
  ...
  elseif 1 == sortType then
    if false == _listSort.ap then
      self._title_Ap:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_ACTIVITY") .. "â–²")
      _listSort.ap = true
    else
      self._title_Ap:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_ACTIVITY") .. "â–¼")
      _listSort.ap = false
  ...
  elseif 2 == sortType then
    if false == _listSort.funds then
      self._title_Funds:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_CURRENTFUNDS") .. "â–²")
