...
function HandleEventLUp_GuildAllianceInvite_All_AddGuildInfo(index)
  UI.ASSERT_NAME(nil ~= index, "HandleEventLUp_GuildAllianceInvite_All_AddGuildInfo index is nil ", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_GuildAllianceInvite_All_ClearGuildInfo(index)
  UI.ASSERT_NAME(nil ~= index, "HandleEventLUp_GuildAllianceInvite_All_ClearGuildInfo index is nil ", "ê¹€ìœ¤ì§€")
