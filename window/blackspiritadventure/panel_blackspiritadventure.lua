...
function PaGlobal_BlackSpiritAdventure:show(cooltimeOff)
  ...
  if true == isExtentionBlackSpiritAdventure then
    if nil ~= bAdventureWebUrl then
      local url = bAdventureWebUrl .. "/MarbleGame/Start" .. tostring(myUserNo) .. "&certKey=" .. tostring(cryptKey) .. "&nationCode=" .. tostring(isNationType)
      _PA_LOG("í—ˆì¬ì„", "url : " .. tostring(url))
      self._Web:SetUrl(self._webSizeX, self._webSizeY, url)
    end
  elseif nil ~= bAdventureWebUrl then
    local url = bAdventureWebUrl .. "/BoardGame" .. tostring(myUserNo) .. "&certKey=" .. tostring(cryptKey) .. "&nationCode=" .. tostring(isNationType) .. "&cooltimeOff=" .. tostring(cooltimeOff)
    _PA_LOG("ê´‘ìš´", "url : " .. tostring(url))
    self._Web:SetUrl(self._webSizeX, self._webSizeY, url)
  end
end
