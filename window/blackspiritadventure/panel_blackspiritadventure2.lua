...
function BlackSpirit2_Show()
  ...
  if nil ~= bAdventureWebUrl then
    local url = bAdventureWebUrl .. "/BlackSpiritAdventure" .. tostring(myUserNo) .. "&certKey=" .. tostring(cryptKey) .. "&serverNo=" .. tostring(serverNo) .. "" .. tostring(userNickName) .. "&characterName=" .. tostring(characterName) .. "&characterNo=" .. tostring(characterNo_64) .. "&nationCode=" .. tostring(isNationType)
