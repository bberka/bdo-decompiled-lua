function PaGlobal_MusicSetting_All:initialize()
  ...
  local marnistxt = UI.getChildControl(self._ui._static_playKindBg, "StaticText_HighGradeMusicalMarnis")
    ...
    if -1 ~= midiType then
      ...
      if true == isOpened then
        if advancedType == __eeInstrumentAdvancedType_Synth then
          ...
          self._ui._rbtn_Track[index].control:SetPosY(marnistxt:GetPosY())
