function PaGlobal_VoiceChat_List_New:initialize()
  ...
  self._ui._btn_sticker = UI.getChildControl(voiceChatTitle, "Button_Sticker")
...
function PaGlobal_VoiceChat_List_New:registEventHandler()
  ...
  self._ui._btn_sticker:addInputEvent("Mouse_LUp", "HandleEventLUp_VoiceChat_List_New_CheckPopupUI()")
