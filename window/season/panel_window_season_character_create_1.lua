...
function PaGlobal_Season_Character_Create:clear()
  self._isPrimiumCharacter = nil
  self._isSeasonCharacter = nil
end
function PaGlobal_Season_Character_Create:prepareOpen(isPrimiumCharacter)
  return self:open(isPrimiumCharacter)
end
...
function PaGlobal_Season_Character_Create:open(isPrimiumCharacter)
  ...
  self:clear()
  self._isPrimiumCharacter = isPrimiumCharacter
...
function PaGlobal_Season_Character_Create:createCharacter(isSeason)
  if nil == self._isPrimiumCharacter then
    return
  end
  self._isSeasonCharacter = isSeason
  self:prepareClose()
  changeCreateCharacterMode_SelectClass(self._isPrimiumCharacter)
  FGlobal_SetPremiumCharacter(self._isPrimiumCharacter)
end
