...
function PaGlobal_SeasonUiSelect_All:initialize()
  ...
  self._ui.stc_imageList[self._seasonUiType.SUMMER] = UI.getChildControl(self._ui.stc_mainBG, "Static_Image_Season")
  self._ui.stc_imageList[self._seasonUiType.WINTER] = UI.getChildControl(self._ui.stc_mainBG, "Static_Image_Winter")
  self._ui.stc_imageList[self._seasonUiType.SPRING] = UI.getChildControl(self._ui.stc_mainBG, "Static_Image_Spring")
  self._ui.stc_radioList[self._seasonUiType.CLASSIC] = UI.getChildControl(self._ui.stc_mainBG, "RadioButton_Classic")
  self._ui.stc_radioList[self._seasonUiType.SUMMER] = UI.getChildControl(self._ui.stc_mainBG, "RadioButton_Season")
  self._ui.stc_radioList[self._seasonUiType.WINTER] = UI.getChildControl(self._ui.stc_mainBG, "RadioButton_Season_Winter")
  self._ui.stc_radioList[self._seasonUiType.SPRING] = UI.getChildControl(self._ui.stc_mainBG, "RadioButton_Spring")
...
function PaGlobal_SeasonUiSelect_All:registEventHandler()
  ...
  self._ui.stc_imageList[self._seasonUiType.SUMMER]:addInputEvent("Mouse_LUp", "HandleEventLUp_SeasonUiSelect_All_SelectType(" .. self._seasonUiType.SUMMER .. ")")
  self._ui.stc_imageList[self._seasonUiType.WINTER]:addInputEvent("Mouse_LUp", "HandleEventLUp_SeasonUiSelect_All_SelectType(" .. self._seasonUiType.WINTER .. ")")
  self._ui.stc_imageList[self._seasonUiType.SPRING]:addInputEvent("Mouse_LUp", "HandleEventLUp_SeasonUiSelect_All_SelectType(" .. self._seasonUiType.SPRING .. ")")
  ...
  self._ui.stc_radioList[self._seasonUiType.SUMMER]:addInputEvent("Mouse_LUp", "HandleEventLUp_SeasonUiSelect_All_SelectType(" .. self._seasonUiType.SUMMER .. ")")
  self._ui.stc_radioList[self._seasonUiType.WINTER]:addInputEvent("Mouse_LUp", "HandleEventLUp_SeasonUiSelect_All_SelectType(" .. self._seasonUiType.WINTER .. ")")
  self._ui.stc_radioList[self._seasonUiType.SPRING]:addInputEvent("Mouse_LUp", "HandleEventLUp_SeasonUiSelect_All_SelectType(" .. self._seasonUiType.SPRING .. ")")
...
function PaGlobal_SeasonUiSelect_All:validate()
  ...
  self._ui.stc_imageList[self._seasonUiType.SUMMER]:isValidate()
  self._ui.stc_imageList[self._seasonUiType.WINTER]:isValidate()
  self._ui.stc_imageList[self._seasonUiType.SPRING]:isValidate()
  self._ui.stc_radioList[self._seasonUiType.CLASSIC]:isValidate()
  self._ui.stc_radioList[self._seasonUiType.SUMMER]:isValidate()
  self._ui.stc_radioList[self._seasonUiType.WINTER]:isValidate()
  self._ui.stc_radioList[self._seasonUiType.SPRING]:isValidate()
...
function PaGlobalFunc_SeasonUiSelect_All_OpenCheck()
  if _ContentsGroup_SeasonUI == false then
    return
  end
  ...
  if false == isExistCacheData then
    ...
    if nil ~= gameOptionSetting and __eSeasonUIType_Default == gameOptionSetting:getSeasonUiType() then
      PaGlobalFunc_SeasonUiSelect_All_Open()
    end
  else
    local lastSavedThemeVersion = ToClient_getGameUIManagerWrapper():getLuaCacheDataListNumber(__eLastUseSeasonThemeUiVersion)
    local latestThemeVersion = ToClient_getLatestUiThemeVersion()
    if lastSavedThemeVersion ~= latestThemeVersion then
...
function PaGlobalFunc_SeasonUiSelect_All_ResetCache()
  ...
  ToClient_getGameUIManagerWrapper():setLuaCacheDataListNumber(__eLastUseSeasonThemeUiVersion, 0, CppEnums.VariableStorageType.eVariableStorageType_User)
end
...
function HandleEventLUp_SeasonUiSelect_All_SelectType(selectType)
  ...
  PaGlobal_SeasonUiSelect_All._ui.stc_radioList[PaGlobal_SeasonUiSelect_All._seasonUiType.SUMMER]:SetCheck(PaGlobal_SeasonUiSelect_All._seasonUiType.SUMMER == PaGlobal_SeasonUiSelect_All._selectType)
  PaGlobal_SeasonUiSelect_All._ui.stc_radioList[PaGlobal_SeasonUiSelect_All._seasonUiType.WINTER]:SetCheck(PaGlobal_SeasonUiSelect_All._seasonUiType.WINTER == PaGlobal_SeasonUiSelect_All._selectType)
  PaGlobal_SeasonUiSelect_All._ui.stc_radioList[PaGlobal_SeasonUiSelect_All._seasonUiType.SPRING]:SetCheck(PaGlobal_SeasonUiSelect_All._seasonUiType.SPRING == PaGlobal_SeasonUiSelect_All._selectType)
end
function HandleEventLUp_SeasonUiSelect_All_Apply()
  local seasonUiType = __eSeasonUIType_Default
  if PaGlobal_SeasonUiSelect_All._selectType == PaGlobal_SeasonUiSelect_All._seasonUiType.CLASSIC then
    seasonUiType = __eSeasonUIType_Default
  elseif PaGlobal_SeasonUiSelect_All._selectType == PaGlobal_SeasonUiSelect_All._seasonUiType.SUMMER then
    seasonUiType = __eSeasonUIType_Summer
  elseif PaGlobal_SeasonUiSelect_All._selectType == PaGlobal_SeasonUiSelect_All._seasonUiType.WINTER then
    seasonUiType = __eSeasonUIType_Winter
  elseif PaGlobal_SeasonUiSelect_All._selectType == PaGlobal_SeasonUiSelect_All._seasonUiType.SPRING then
    seasonUiType = __eSeasonUIType_Spring
  else
    UI.ASSERT_NAME(false, "ë°œìƒí•˜ë©´ ì•ˆë©ë‹ˆë‹¤. ì‹œì¦Œ í…Œë§ˆ í…ìŠ¤ì³ íƒ€ì…ì´ ë¹„ì •ìƒì…ë‹ˆë‹¤..", "ì´ì£¼")
  end
  local gameOptionSetting = ToClient_getGameOptionControllerWrapper()
  if nil == gameOptionSetting then
    return
  end
  local currentSeasonUiType = gameOptionSetting:getSeasonUiType()
  if seasonUiType ~= currentSeasonUiType then
    setSeasonUiType(seasonUiType)
  end
  ...
  ToClient_getGameUIManagerWrapper():setLuaCacheDataListNumber(__eLastUseSeasonThemeUiVersion, ToClient_getLatestUiThemeVersion(), CppEnums.VariableStorageType.eVariableStorageType_User)
  PaGlobalFunc_SeasonUiSelect_All_Close()
end
