...
function PaGlobal_Masterpiece_Auction_All:itemListSetting(isShow)
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_Masterpiece_Auction_All:itemListSettingì˜ isShow nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function PaGlobal_Masterpiece_Auction_All:setItemListSetting(isShow)
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_Masterpiece_Auction_All:setItemListSettingì˜ isShow nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == Panel_Masterpiece_Auction_All then
    return
  end
...
function PaGlobal_Masterpiece_Auction_All:setBidListSetting(isShow)
  UI.ASSERT_NAME(nil ~= isShow, "PaGlobal_Masterpiece_Auction_All:setBidListSettingì˜ isShow nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if nil == Panel_Masterpiece_Auction_All then
    return
  end
  self._ui.bidList.list2_myBid:SetShow(isShow)
...
function PaGlobal_Masterpiece_Auction_All:bidTypeMessage(idx)
  UI.ASSERT_NAME(nil ~= idx, "PaGlobal_Masterpiece_Auction_All:bidTypeMessageì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if 2 == index then
