function PaGlobal_GuildHouse_Auction_Detail_All_Open(idx, tabType)
  UI.ASSERT_NAME(nil ~= idx, "PaGlobal_GuildHouse_Auction_Detail_All_Openì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= tabType, "PaGlobal_GuildHouse_Auction_Detail_All_Openì˜ tabType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
