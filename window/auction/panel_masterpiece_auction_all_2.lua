...
function HandleEventOn_Masterpiece_Auction_All_SimpleTooltip(isShow, index)
  UI.ASSERT_NAME(nil ~= isShow, "HandleEventOn_Masterpiece_Auction_All_SimpleTooltipì˜ isShow nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= index, "HandleEventOn_Masterpiece_Auction_All_SimpleTooltipì˜ index nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventOn_Masterpiece_Auction_All_ShowTooltip(isShow, index, auctionType)
  UI.ASSERT_NAME(nil ~= isShow, "HandleEventOn_Masterpiece_Auction_All_ShowTooltipì˜ isShow nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= index, "HandleEventOn_Masterpiece_Auction_All_ShowTooltipì˜ index nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= auctionType, "HandleEventOn_Masterpiece_Auction_All_ShowTooltipì˜ auctionType nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  if false == isShow then
...
function HandleEventLUp_Masterpiece_Auction_All_ItemListControlCreate(control, key)
  UI.ASSERT_NAME(nil ~= control, "HandleEventLUp_Masterpiece_Auction_All_ItemListControlCreateì˜ control nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Masterpiece_Auction_All_ItemListControlCreateì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Masterpiece_Auction_All_SetInfomation(idx)
  UI.ASSERT_NAME(nil ~= idx, "HandleEventLUp_Masterpiece_Auction_All_SetInfomationì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  local myAuctionInfo = RequestGetAuctionInfo()
  if nil == myAuctionInfo then
    return
  end
...
function HandleEventLUp_Masterpiece_Auction_All_BidButton(key)
  UI.ASSERT_NAME(nil ~= key, "HandleEventLUp_Masterpiece_Auction_All_BidButtonì˜ key nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
  local key_32 = Int64toInt32(key)
...
function HandleEventLUp_Masterpiece_Auction_All_CancelBidorSell(index)
  UI.ASSERT_NAME(nil ~= index, "HandleEventLUp_Masterpiece_Auction_All_CancelBidorSellì˜ index nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function HandleEventLUp_Masterpiece_Auction_All_GetSuccessItemorMoney(index)
  UI.ASSERT_NAME(nil ~= index, "HandleEventLUp_Masterpiece_Auction_All_GetSuccessItemorMoneyì˜ index nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
...
function PaGlobal_Masterpiece_Auction_All_SetBidTypeIndex(idx)
  UI.ASSERT_NAME(nil ~= idx, "PaGlobal_Masterpiece_Auction_All_SetBidTypeIndexì˜ idx nilì´ë©´ ì•ˆëœë‹¤.", "ê¹€ìœ¤ì§€")
