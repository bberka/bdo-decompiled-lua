...
function PaGlobal_ScreenShot_SNS:prepareOpen(productNoRaw)
  ...
  url = url .. "/ScreenShot/MyGallery/ScreenShotCostumeSNS" .. tostring(productNoRaw) .. "&userNo=" .. tostring(userNo) .. "&userNickName=" .. tostring(userNickName) .. "&classType=" .. tostring(classType) .. "&certKey=" .. tostring(cryptKey) .. "&isGm=" .. tostring(isGm) .. "&isXbox=" .. tostring(isXbox)
  self._ui._web_StyleAlbum:ResetUrl()
