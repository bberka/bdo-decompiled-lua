...
function itemMarketSupport:init()
  ...
  itemMarketSupport.testCaseToStirng[ItemMarketTestCaseEnum.eBuy] = "êµ¬ë§¤"
  itemMarketSupport.testCaseToStirng[ItemMarketTestCaseEnum.eSell] = "íŒë§¤"
end
...
function itemMarketSupport:endTest()
  ...
  ToClient_QAsupportFileWrite("<í…ŒìŠ¤íŠ¸ë²ˆí˜¸>\t[í…ŒìŠ¤íŠ¸í•­ëª©]\t[ìµœì¢…ê²°ê³¼]\t[ê¸°ëŒ€ê²°ê³¼]\t[ì‹¤ì œê²°ê³¼]\t<í…ŒìŠ¤íŠ¸ë²ˆí˜¸>\t[ìƒí™©]\t[ìƒì„¸ ì„¤ëª…]\n")
  for index, content in pairs(itemMarketSupport.testList) do
