...
function CustomizingAlbum_Open(isCTMode, isSceneState)
  ...
  url = url .. "/customizing" .. tostring(userNo) .. "&userNickname=" .. tostring(userNickName) .. "&certKey=" .. tostring(cryptKey) .. "&classType=" .. tostring(classType) .. "&isCustomizationMode=" .. tostring(true == isCTMode)
  if true == isGm then
