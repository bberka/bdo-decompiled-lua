...
function SetLoadingTexturePathForException()
  ...
  if isGameTypeKR2() then
    ...
    bgImageTexture = {
      ...
      [3] = "New_UI_Common_ForLua/Window/Lobby/bgCalpeon_2.dds",
      [4] = "New_UI_Common_ForLua/Window/Lobby/bgCalpeon_3.dds",
      [5] = "New_UI_Common_ForLua/Window/Lobby/bgCalpeon_4.dds",
      ["count"] = 6
    }
    _moviePath = nil
    _movieURL = nil
  ...
  if true == ToClient_isHadumChannel() then
    isBgOpen = true
    bgImageTexture = {}
    bgImageTexture = {
      [0] = "Combine/Loading/Hadum.dds",
      ["count"] = 1
    }
    _moviePath = nil
    _movieURL = nil
  ...
  if true == _ContentsGroup_DracaniaAwaken then
    ...
    bgImageTexture = {}
    bgImageTexture = {
      [0] = "Combine/Loading/Character/Loading_1.dds",
      ["count"] = 1
    }
    _moviePath = nil
    _movieURL = nil
  ...
  if true == _ContentsGroup_SolareMatching then
    isBgOpen = true
    bgImageTexture = {}
    bgImageTexture = {
      [0] = "Combine/Loading/Character/Loading_1.dds",
      [1] = "Combine/Loading/Solrare/Solrare_Loading_Map04.dds",
      ["count"] = 2
    }
    _moviePath = nil
    _movieURL = nil
  ...
  bgImageTexture = {}
  bgImageTexture = {
    [0] = "Combine/Loading/Abyss_One/Abyss_One.dds",
    ["count"] = 1
  }
  _moviePath = nil
  _movieURL = nil
...
function LoadingPanel_Resize()
  ...
  progressRate:SetSize(screenOriX * 0,8 * uiScale, progressRate:GetSizeY() * uiScale)
