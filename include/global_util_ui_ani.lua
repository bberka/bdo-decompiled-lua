...
function UIAni.showAniScaleElastic(panel, params)
  _PA_ASSERT(nil ~= panel, "panel ë§¤ê°œë³€ìˆ˜ëŠ” ë„£ì–´ ì£¼ì…”ì•¼ í•©ë‹ˆë‹¤!")
  if nil == params then
    params = {}
  end
  ...
  if startTime > middleTime then
    _PA_LOG("ì´ì¬ì¤€", "ì˜ëª»ëœ middleTimeì„ ì„¤ì •í–ˆìŠµë‹ˆë‹¤. middleTimeì„ ê°•ì œë¡œ ë³€ê²½í•©ë‹ˆë‹¤.")
    middleTime = startTime + 0,08
  end
  if endTime < middleTime then
    _PA_LOG("ì´ì¬ì¤€", "ì˜ëª»ëœ endTimeì„ ì„¤ì •í–ˆìŠµë‹ˆë‹¤. endTimeì„ ê°•ì œë¡œ ë³€ê²½í•©ë‹ˆë‹¤.")
