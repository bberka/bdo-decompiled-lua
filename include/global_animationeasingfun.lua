...
function PaGlobal_AnimationEasingFun_easeOutBounce(timeDelta)
  if timeDelta < 0,363636363636364 then
    return 7,5625 * timeDelta * timeDelta
  elseif timeDelta < 0,727272727272727 then
    timeDelta = timeDelta - 0,545454545454545
    local postFix = timeDelta
    return 7,5625 * postFix * timeDelta + 0,75
  elseif timeDelta < 0,909090909090909 then
    timeDelta = timeDelta - 0,818181818181818
    local postFix = timeDelta
    return 7,5625 * postFix * timeDelta + 0,9375
  else
    timeDelta = timeDelta - 0,954545454545455
    local postFix = timeDelta
