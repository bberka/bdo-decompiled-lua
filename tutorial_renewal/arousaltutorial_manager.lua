  ...
  [__eClassType_Warrior] = {
    [0] = {
      ...
      combo = {
        ...
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Warrior_0_Combo_1"),
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Warrior_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Warrior_1_Combo_2")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Warrior_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Warrior_1_ComboKey_2")
      }
    }
  },
  [__eClassType_ElfRanger] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ranger_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ranger_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ranger_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ranger_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Sorcerer] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Socceror_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Socceror_0_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Socceror_0_ComboKey_3"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Socceror_0_ComboKey_1")
      }
    }
  },
  [__eClassType_Giant] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Tamer] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Tamer_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Tamer_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_0_ComboKey_1"),
        comboKeyStr,
  ...
  [__eClassType_BladeMaster] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMaster_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMaster_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMaster_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMaster_1_ComboKey_3")
      }
    }
  },
  [__eClassType_BladeMasterWoman] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMasterWoman_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMasterWoman_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMasterWoman_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_BladeMasterWoman_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Valkyrie] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Valkyrie_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Valkyrie_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Valkyrie_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Valkyrie_1_ComboKey_3")
      }
    }
  },
  [__eClassType_WizardMan] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WIZARD_COMBO_0_1")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WIZARD_COMBO_1_2")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WIZARD_COMBOKEY_1_0"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WIZARD_COMBOKEY_1_2")
      }
    }
  },
  [__eClassType_WizardWoman] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WITCH_COMBO_0_1")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WITCH_COMBO_1_2")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WITCH_COMBOKEY_1_0"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_WITCH_COMBOKEY_1_2")
      }
    }
  },
  [__eClassType_NinjaMan] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ninja_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ninja_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ninja_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Ninja_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Kunoichi] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_NinjaWoman_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_NinjaWoman_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_NinjaWoman_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_NinjaWoman_1_ComboKey_3")
      }
    }
  },
  [__eClassType_DarkElf] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DarkElf_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DarkElf_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DarkElf_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DarkElf_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Combattant] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Combattant_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Combattant_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Combattant_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Combattant_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Mystic] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CombattantWoman_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CombattantWoman_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CombattantWoman_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CombattantWoman_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Lhan] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Lahn_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Lahn_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Lahn_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Lahn_1_ComboKey_3")
      }
    }
  },
  [__eClassType_RangerMan] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_0_Combo_4")
      },
      comboKey = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_0_ComboKey_4")
      }
    },
    [1] = {
      questGroup = 347,
      ...
      combo = {
        ...
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_1_Combo_1"),
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_1_Combo_1"),
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_1_Combo_1")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_1_ComboKey_1"),
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_1_ComboKey_1"),
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_1_ComboKey_1"),
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_RangerMan_1_ComboKey_1")
      }
    }
  },
  [__eClassType_Guardian] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Guardian_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Guardian_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Guardian_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Guardian_1_ComboKey_2")
      }
    }
  },
  [__eClassType_Hashashin] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Hashashin_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Hashashin_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Hashashin_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Hashashin_1_ComboKey_2")
      }
    },
    [2] = {
      questGroup = 845,
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_EVENT_TUTORIAL_COMBO_Hashashin_0_Combo_4")
      },
      comboKey = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_EVENT_TUTORIAL_COMBO_Hashashin_0_ComboKey_4")
      }
    },
    [3] = {
      questGroup = 845,
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_EVENT_TUTORIAL_COMBO_Hashashin_1_Combo_4")
      },
      comboKey = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_EVENT_TUTORIAL_COMBO_Hashashin_1_ComboKey_4")
      }
    }
  },
  [__eClassType_Nova] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Nova_0_Combo_2")
      },
      comboKey = {
    ...
    [1] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Nova_1_Combo_3")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Nova_1_ComboKey_1"),
        comboKeyStr,
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Nova_1_ComboKey_2")
      }
    }
  },
  [__eClassType_Sage] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_SAGE_0_Combo_2")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_SAGE_0_ComboKey_1"),
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_SAGE_0_ComboKey_2")
      }
    },
    [1] = {
      questGroup = 368,
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_SAGE_1_Combo_3")
      },
      comboKey = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_SAGE_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Corsair] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CORSAIR_0_Combo_2")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CORSAIR_0_ComboKey_1"),
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CORSAIR_0_ComboKey_2")
      }
    },
    [1] = {
      questGroup = 369,
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CORSAIR_1_Combo_2")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CORSAIR_1_ComboKey_1"),
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_CORSAIR_1_ComboKey_2")
      }
    }
  },
  [__eClassType_Drakania] = {
    [0] = {
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DRAKANIA_0_Combo_2")
      },
      comboKey = {
        PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DRAKANIA_0_ComboKey_1"),
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DRAKANIA_0_ComboKey_2")
      }
    },
    [1] = {
      questGroup = 371,
      ...
      combo = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DRAKANIA_1_Combo_3")
      },
      comboKey = {
        ...
        [18] = PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_DRAKANIA_1_ComboKey_3")
      }
    }
  },
  [__eClassType_Giant_Reserved0] = {
  ...
  for index = 0, #questCheck[classType] do
    if questList_hasProgressQuest(questCheck[classType][index].questGroup, questCheck[classType][index].questId) then
      ...
      if nil == uiQuestInfo then
        _PA_ASSERT(false, "ê³µì¡´í•  ìˆ˜ ì—†ëŠ” í€˜ìŠ¤íŠ¸ê°€ ê³µì¡´í•´ì„œ ë¬¸ì œê°€ ìƒê²¼ìŠµë‹ˆë‹¤. ì™„ë£Œí–ˆì–´ì•¼ í•˜ëŠ” ì—°ê³„í€˜ìŠ¤íŠ¸ë¥¼ ì–µì§€ë¡œ ì´ˆê¸°í™”í•˜ê³  ë‹¤ì‹œ ë°›ìœ¼ë©´ ì´ëŸ´ ìˆ˜ ìˆìŠµë‹ˆë‹¤.")
        return
      end
