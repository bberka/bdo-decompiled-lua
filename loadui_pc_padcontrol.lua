...
function loadLoadingUI_PC()
  ...
  runLua("UI_Data/Script/Window/MessageBox/MessageBox_Common.lua")
  runLua("UI_Data/Script/Window/MessageBox/Panel_Window_MessageBox_All.lua")
  if _ContentsGroup_LoadingSceneLoadWorldMap == true then
...
function preLoadGameUI_PC()
  ...
  if true == _ContentsGroup_InstanceHorseRacing then
    basicLoadUI("UI_Data/Window/HorseRacing/Panel_HorseRacing_Match_Confirm.XML", "Panel_HorseRacing_Match_Confirm", UIGroup.PAGameUIGroup_Windows)
  ...
  basicLoadUI("UI_Data/Window/Solrare/Panel_Popup_Solare_MatchConfirm_All.XML", "Panel_Popup_Solare_MatchConfirm", UIGroup.PAGameUIGroup_Windows)
  ...
  basicLoadUI("UI_Data/Window/Solrare/Panel_Window_Solare_Equip_Set_BlackBG.XML", "Panel_Solrare_EquipPresetBlockBg", UIGroup.PAGameUIGroup_GameSystemMenu)
  basicLoadUI("UI_Data/Window/Solrare/Panel_Window_Solare_Equip_Set.XML", "Panel_Solrare_EquipPresetList", UIGroup.PAGameUIGroup_ModalDialog)
  ...
  if true == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_Solare) then
    ...
    basicLoadUI("UI_Data/Window/Solrare/Panel_Widget_Solare_TierUpgrade.XML", "Panel_Widget_Solare_TierUpgrade", UIGroup.PAGameUIGroup_Interaction)
  end
  ...
  loadUI("UI_Data/Widget/Roadmap/Panel_Widget_RoadMap.XML", "Panel_Window_BeginnerRoadmap", UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
    RenderMode.eRenderMode_Default,
  ...
  if true == _ContentsGroup_OldMoonSmelting then
    loadUI("UI_Data/Window/OldMoon/Panel_Window_OldMoonSmelting.XML", "Panel_Window_OldMoonSmelting", UIGroup.PAGameUIGroup_Alert, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_Dialog
    }))
  end
  ...
  basicLoadUI("UI_Data/Window/ContentsRotation/Panel_Window_ContentsRotation.XML", "Panel_Window_ContentsRotation", UIGroup.PAGameUIGroup_Windows)
  ...
  basicLoadUI("UI_Data/Widget/Console/Panel_Widger_Camera_Mode.xml", "Panel_Widget_CameraMode_All", UIGroup.PAGameUIGroup_MainUI)
  ...
  if true == _ContentsGroup_SnowAntLabyrinth then
    basicLoadUI("UI_Data/Widget/NakMessage/NakMessage_Erethea.xml", "Panel_NakMessage_Erether_All", UIGroup.PAGameUIGroup_ModalDialog)
  end
  ...
  basicLoadUI("UI_Data/Widget/NakMessage//Panel_Widget_NakMessageChoice_All.XML", "Panel_Widget_NakMessageChoice_All", UIGroup.PAGameUIGroup_ModalDialog)
...
function loadGameUI_PC()
  ...
  if true == _ContentsGroup_OldMoonSmelting then
    runLua("UI_Data/Script/Window/OldMoon/Panel_Window_OldMoonSmelting.lua")
  end
  if true == _ContentsGroup_IceFishingGame then
  ...
  runLua("UI_Data/Script/Window/ContentsRotation/Panel_Window_ContentsRotation.lua")
